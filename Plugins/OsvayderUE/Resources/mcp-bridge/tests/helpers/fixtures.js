 ...
 *
 * Mirrors the JSON shapes returned by the OsvayderUE plugin HTTP server.
 */
...
export const TOOL_EXECUTE_POLICY_DENIED = {
  success: false,
  message: "Policy denied [workspace_write_project.broad_authoring_mutation_surface_denied]: representative mutation surface is gated",
  data: {
    result_type: "policy_denied",
    tool_name: "spawn_actor",
    policy_denied_contract: {
      requested_lane: "workspace_write_project",
      effective_lane: "workspace_write_project",
      policy_rule_id: "workspace_write_project.broad_authoring_mutation_surface_denied",
      governing_family: "broad_authoring_mutation_backlog",
...
export const TOOL_EXECUTE_AUTH_DENIED = {
  success: false,
  error: "MCP authentication failed",
  message: "MCP authentication failed: invalid_token",
  data: {
    result_type: "auth_denied",
    schema_version: "mcp_auth_denial.v1",
    error_category: "auth_denied",
    denial_reason: "invalid_token",
    endpoint: "/mcp/tool/spawn_actor",
    tool_name: "spawn_actor",
    token_header_present: true,
    token_value_redacted: true,
    structured_denial: true,
  },
};

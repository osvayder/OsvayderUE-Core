 ...
 */
class SOsvayderInputArea : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SOsvayderInputArea)
		: _bIsWaiting(false)
	{}
		...
		SLATE_ATTRIBUTE(EOsvayderUEVoiceDictationState, DictationState)
...
private:
	...
	FText GetInputStatusText() const;
	FSlateColor GetSendButtonTextColor() const;
...
private:
	...
	TAttribute<EOsvayderUEVoiceDictationState> DictationState;

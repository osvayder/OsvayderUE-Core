 ...
 */
class SOsvayderToolbar : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SOsvayderToolbar)
		: _TitleText(FText::FromString(TEXT("Osvayder UE")))
		, _ProviderSummaryText(FText::GetEmpty())
		, _ModelText(FText::GetEmpty())
		, _ModelToolTip(FText::GetEmpty())
		, _ProfileText(FText::GetEmpty())
		, _ProfileToolTip(FText::GetEmpty())
	...
	{}
		...
		SLATE_ATTRIBUTE(FText, ModelText)
		SLATE_ATTRIBUTE(FText, ModelToolTip)
		SLATE_ATTRIBUTE(FText, ProfileText)
		SLATE_ATTRIBUTE(FText, ProfileToolTip)
	...
	static FText GetDeferredTasksMenuLabel();
...
private:
	...
	TAttribute<FText> ModelText;
	TAttribute<FText> ModelToolTip;
	TAttribute<FText> ProfileText;
	TAttribute<FText> ProfileToolTip;
	...
	TSharedRef<SWidget> BuildToolbarChip(const FText& Label, const TAttribute<FText>& Value, const FSlateBrush* Brush, const FSlateColor& ValueColor, const TAttribute<FText>& ToolTip) const;

...
FMCPToolResult FMCPTool_EnhancedInput::ExecuteCreateInputAction(const TSharedRef<FJsonObject>& Params)
{
	...
	UE_LOG(LogOsvayderUE, Log, TEXT("Created InputAction: %s (ValueType: %s)"), *FullPath, *ValueTypeStr);
...
FMCPToolResult FMCPTool_EnhancedInput::ExecuteCreateMappingContext(const TSharedRef<FJsonObject>& Params)
{
	...
	UE_LOG(LogOsvayderUE, Log, TEXT("Created InputMappingContext: %s"), *FullPath);
...
FMCPToolResult FMCPTool_EnhancedInput::ExecuteAddMapping(const TSharedRef<FJsonObject>& Params)
{
	...
	UE_LOG(LogOsvayderUE, Log, TEXT("Added mapping: %s -> %s in %s"),
...
FMCPToolResult FMCPTool_EnhancedInput::ExecuteRemoveMapping(const TSharedRef<FJsonObject>& Params)
{
	...
	UE_LOG(LogOsvayderUE, Log, TEXT("Removed mapping at index %d: %s -> %s"),
...
FMCPToolResult FMCPTool_EnhancedInput::ExecuteAddTrigger(const TSharedRef<FJsonObject>& Params)
{
	...
	UE_LOG(LogOsvayderUE, Log, TEXT("Added %s trigger to %s in %s"),
...
FMCPToolResult FMCPTool_EnhancedInput::ExecuteAddModifier(const TSharedRef<FJsonObject>& Params)
{
	...
	UE_LOG(LogOsvayderUE, Log, TEXT("Added %s modifier to %s in %s"),
...
bool FMCPTool_EnhancedInput::SaveAsset(UObject* Asset, FString& OutError)
{
	...
	Receipt.Tool = TEXT("enhanced_input:save_asset");
	Receipt.TargetType = TEXT("asset");
	Receipt.Targets.Add(Asset->GetPathName());
	...
	if (!UEditorAssetLibrary::SaveAsset(PackagePath, false))
	{
		...
		Receipt.Status = TEXT("failed");
		Receipt.ErrorOrDenialReason = OutError;
	...
	Receipt.Summary = FString::Printf(TEXT("Saved asset: %s"), *Asset->GetPathName());
	Receipt.Modified.Add(Asset->GetPathName());
	FOsvayderUEExecutionLog::Get().AddReceipt(Receipt);

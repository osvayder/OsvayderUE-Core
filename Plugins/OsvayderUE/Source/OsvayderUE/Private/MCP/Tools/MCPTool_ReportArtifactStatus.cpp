...
{
	FOsvayderUEReportQueryOptions QueryOptions;
	...
	const TArray<TSharedPtr<FJsonObject>> Reports = FOsvayderUEReportArtifacts::QueryReports(QueryOptions);

	TSharedPtr<FJsonObject> Data = MakeShared<FJsonObject>();
	Data->SetStringField(TEXT("reports_dir"), FOsvayderUEReportArtifacts::GetReportsDirectory());
	Data->SetStringField(TEXT("summary_glob"), FOsvayderUEReportArtifacts::GetReportSummaryGlob());

...
bool FMCPTool_CharacterData::SaveAsset(UObject* Asset, FString& OutError)
{
	...
	Receipt.Tool = TEXT("character_data:save_asset");
	...
	if (Result.Result != ESavePackageResult::Success)
	{
		...
		Receipt.ErrorOrDenialReason = FString::Printf(TEXT("Failed to save asset: %s"), *PackageFileName);
		OutError = Receipt.ErrorOrDenialReason;

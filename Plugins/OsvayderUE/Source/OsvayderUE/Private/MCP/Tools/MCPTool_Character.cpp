...
TSharedPtr<FJsonObject> FMCPTool_Character::CharacterToJson(ACharacter* Character, bool bIncludeMovement)
{
	...
	// Transform
	Json->SetObjectField(TEXT("location"), OsvayderUEJsonUtils::VectorToJson(Character->GetActorLocation()));
	Json->SetObjectField(TEXT("rotation"), OsvayderUEJsonUtils::RotatorToJson(Character->GetActorRotation()));
...
TSharedPtr<FJsonObject> FMCPTool_Character::MovementComponentToJson(UCharacterMovementComponent* Movement)
{
	...
	Json->SetObjectField(TEXT("velocity"), OsvayderUEJsonUtils::VectorToJson(Movement->Velocity));
...
TSharedPtr<FJsonObject> FMCPTool_Character::ComponentToJson(UActorComponent* Component)
{
	...
	if (USceneComponent* SceneComp = Cast<USceneComponent>(Component))
	{
		...
		Json->SetObjectField(TEXT("relative_location"), OsvayderUEJsonUtils::VectorToJson(SceneComp->GetRelativeLocation()));
		Json->SetObjectField(TEXT("relative_rotation"), OsvayderUEJsonUtils::RotatorToJson(SceneComp->GetRelativeRotation()));

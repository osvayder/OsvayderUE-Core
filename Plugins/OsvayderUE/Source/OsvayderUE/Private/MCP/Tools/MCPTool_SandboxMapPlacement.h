...
public:
	virtual FMCPToolInfo GetInfo() const override
	{
		...
		Info.Description = TEXT(
			...
			"Map paths must stay under /Game/__OsvayderUETestSandbox/packet<digits>_*; production maps and raw disk paths are rejected.");
		Info.Parameters = {
			FMCPToolParameter(TEXT("map_path"), TEXT("string"), TEXT("Required long package path under /Game/__OsvayderUETestSandbox/packet<digits>_*"), true),

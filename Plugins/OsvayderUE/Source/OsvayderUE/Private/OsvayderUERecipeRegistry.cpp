...
TSharedPtr<FJsonObject> FOsvayderUERecipeEvidenceContract::ToJsonObject() const
{
...
namespace OsvayderUERecipeRegistry
{
	...
	FOsvayderUERecipeEvidenceContract GetInteractionAccessRecipeEvidenceContract()
	{
		...
		Contract.RequiredFocusedTests = {
			TEXT("OsvayderUE.RecipeRegistry.InteractionAccessContract"),
			TEXT("OsvayderUE.ActivePlanCloseout.SystemicVerifierJudge.RecipeRegistryUnknownRecipeFailsClosed"),
			TEXT("OsvayderUE.ActivePlanCloseout.SystemicVerifierJudge.RecipeRegistryMissingObligationNamesMissingFact"),
			TEXT("OsvayderUE.ActivePlanCloseout.SystemicVerifierJudge.ExecutionTruthManagedStateCommandRejectsWithoutLegacyMutationFlag"),
			TEXT("OsvayderUE.ActivePlanCloseout.SystemicVerifierJudge.RunScopedOldTraceManualWriteDoesNotPoisonCleanRun")
		};
	...
	FOsvayderUERecipeEvidenceContract GetInventoryBasicUiRecipeEvidenceContract()
	{
		FOsvayderUERecipeEvidenceContract Contract;
		...
		Contract.RequiredFocusedTests = {
			TEXT("OsvayderUE.ActivePlanCloseout.FeatureWorkflowCompileAndRuntimeCanBeFull")
		};
		return Contract;
	}
		...
		FOsvayderUERecipeEvidenceContract& OutContract)
	{
		...
		OutContract = FOsvayderUERecipeEvidenceContract();
		return false;
	}

	TArray<FOsvayderUERecipeEvidenceContract> GetAllRecipeEvidenceContracts()
	{
		return {

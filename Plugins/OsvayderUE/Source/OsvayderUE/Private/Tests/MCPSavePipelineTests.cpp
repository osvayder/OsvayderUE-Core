...
namespace OsvayderUE::MutationLifecycleTests
{
	/**
	...
	{
		const FString LongName = FString::Printf(TEXT("/Engine/Transient/OsvayderUELifecycleTest_%s"), *ShortName);
	...
	{
		const FString LongName = FString::Printf(TEXT("/Engine/Transient/OsvayderUELifecycleTest_Level_%s"), *ShortName);
		UPackage* Package = CreatePackage(*LongName);
		if (!Package)
		{
			return nullptr;
	...
	UPackage* CreateTestBlueprintPackage(const FString& ShortName, UBlueprint*& OutBlueprint)
	{
		...
		const FString LongName = FString::Printf(TEXT("/Engine/Transient/OsvayderUELifecycleTest_BP_%s"), *ShortName);
		UPackage* Package = CreatePackage(*LongName);
		if (!Package)
		{
			return nullptr;
...
using namespace OsvayderUE::MutationLifecycleTests;

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMCPSavePipeline_Wrapper_ReadOnlyTool_NoLifecycle,
	"OsvayderUE.MutationLifecycle.Wrapper_ReadOnlyTool_NoLifecycle",
...
bool FMCPSavePipeline_Wrapper_ReadOnlyTool_NoLifecycle::RunTest(const FString& /*Parameters*/)
{
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_readonly");
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Wrapper_ModifyingTool_AutoSaveOn_RunsLifecycle",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Wrapper_ModifyingTool_AutoSaveOn_RunsLifecycle::RunTest(const FString& /*Parameters*/)
{
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_modifying_on");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Wrapper_ModifyingTool_AutoSaveOff_SkipsLifecycle",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Wrapper_ModifyingTool_AutoSaveOff_SkipsLifecycle::RunTest(const FString& /*Parameters*/)
{
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_modifying_off");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[TestPackage]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Wrapper_ToolFailure_DoesNotPersist",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Wrapper_ToolFailure_DoesNotPersist::RunTest(const FString& /*Parameters*/)
{
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_failing");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[TestPackage]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Wrapper_ToolSuccessNoMutation_NoLifecycle",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Wrapper_ToolSuccessNoMutation_NoLifecycle::RunTest(const FString& /*Parameters*/)
{
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_no_mutation");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Wrapper_LevelPackage_SkipsWithDocumentedReason",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Wrapper_LevelPackage_SkipsWithDocumentedReason::RunTest(const FString& /*Parameters*/)
{
	...
	TestTrue(TEXT("Level test package must be classified as a level package"),
		OsvayderUE::SavePipeline::IsLevelPackage(LevelPackage));

	FMCPToolRegistry Registry;

	const FString ToolName = TEXT("osvayderue_lifecycle_test_level_mutation");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_BlueprintMutation_CompilesBeforeSave",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_BlueprintMutation_CompilesBeforeSave::RunTest(const FString& /*Parameters*/)
{
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_bp_compile_ok");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
	...
	for (const TSharedPtr<FJsonValue>& Value : *CompileArray)
	{
		...
		if (ResultStr.Equals(TEXT("ok")) && AssetStr.Contains(TEXT("OsvayderUELifecycleTest_BP_CompilesBeforeSave")))
		{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_BlueprintCompileFailure_DoesNotSave_ReportsError",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_BlueprintCompileFailure_DoesNotSave_ReportsError::RunTest(const FString& /*Parameters*/)
{
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_bp_compile_fail");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[BlueprintPackage]() -> FMCPToolResult
	...
	if (FailedArray)
	{
		for (const TSharedPtr<FJsonValue>& Value : *FailedArray)
		{
			...
			FString AssetStr;
			(*Entry)->TryGetStringField(TEXT("asset"), AssetStr);
			if (PhaseStr.Equals(TEXT("compile")) && AssetStr.Contains(TEXT("OsvayderUELifecycleTest_BP_CompileFailure")))
			{
	...
	if (SavedArray)
	{
		...
		{
			FString Saved;
			if (Value->TryGetString(Saved) && Saved.Contains(TEXT("OsvayderUELifecycleTest_BP_CompileFailure")))
			{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_BlueprintCompile_StaleCDO_Diagnosed",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_SourceControlInactive_SkipsCheckout",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_SourceControlInactive_SkipsCheckout::RunTest(const FString& /*Parameters*/)
{
	...
	OsvayderUE::SavePipeline::Testing::SetSourceControlIsEnabledOverride([]() { return false; });
	ON_SCOPE_EXIT { OsvayderUE::SavePipeline::Testing::ClearSourceControlOverrides(); };
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_sc_inactive");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[TestPackage]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_SourceControlActive_CheckoutSilent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_SourceControlActive_CheckoutSilent::RunTest(const FString& /*Parameters*/)
{
	...
	OsvayderUE::SavePipeline::Testing::SetSourceControlIsEnabledOverride([]() { return true; });
	OsvayderUE::SavePipeline::Testing::SetSourceControlCheckOutOverride(
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_sc_active");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[TestPackage]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_NewAsset_RegistersInAssetRegistry",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_NewAsset_RegistersInAssetRegistry::RunTest(const FString& /*Parameters*/)
{
	...
	ON_SCOPE_EXIT { OsvayderUE::SavePipeline::Testing::ClearAssetCreatedOverride(); };

	OsvayderUE::SavePipeline::FLifecycleOutcome Outcome;
	OsvayderUE::SavePipeline::NotifyAssetRegistryCreated(Package, Outcome);
	...
	if (TestTrue(TEXT("empty package must be creatable"), EmptyPackage != nullptr))
	{
		...
		OsvayderUE::SavePipeline::FLifecycleOutcome EmptyOutcome;
		OsvayderUE::SavePipeline::NotifyAssetRegistryCreated(EmptyPackage, EmptyOutcome);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_ExistingAsset_DoesNotDoubleRegister",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_ExistingAsset_DoesNotDoubleRegister::RunTest(const FString& /*Parameters*/)
{
	...
	using OsvayderUE::SavePipeline::ShouldNotifyAssetRegistryCreated;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_Save_NewlyCreatedDataAsset_Silent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_Save_NewlyCreatedDataAsset_Silent::RunTest(const FString& /*Parameters*/)
{
	...
	const FString LongName = FString::Printf(
		TEXT("/Game/OsvayderUELifecycleTest_EMP1_%s"), *UniqueSuffix.Replace(TEXT("-"), TEXT("")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_Reentrancy_BundledMutation_SavesOnce",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_Reentrancy_BundledMutation_SavesOnce::RunTest(const FString& /*Parameters*/)
{
	...
	ON_SCOPE_EXIT { OsvayderUE::SavePipeline::Testing::ClearSavePackageOverride(); };

	FMCPToolRegistry Registry;

	// Inner modifying tool — dirties InnerPackage.
	const FString InnerToolName = TEXT("osvayderue_lifecycle_test_inner_mutation");
	...
	const FString OuterToolName = TEXT("osvayderue_lifecycle_test_outer_mutation");
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_BackgroundThreadCall_DispatchesAndCompletes",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_BackgroundThreadCall_DispatchesAndCompletes::RunTest(const FString& /*Parameters*/)
{
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_bg_thread");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[TestPackage]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_ErrorReporting_MultiPhaseFailure_CoversAllSurfaces",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_ErrorReporting_MultiPhaseFailure_CoversAllSurfaces::RunTest(const FString& /*Parameters*/)
{
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_multiphase");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[BlueprintPackage]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_Phase_D_MissingMainObject_ReportsRegistryFailure",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_Phase_D_MissingMainObject_ReportsRegistryFailure::RunTest(const FString& /*Parameters*/)
{
	...
	OsvayderUE::SavePipeline::FLifecycleOutcome Outcome;
	OsvayderUE::SavePipeline::NotifyAssetRegistryCreated(EmptyPackage, Outcome);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Pipeline_Telemetry_MutationLifecycleReceiptEmitted",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Pipeline_Telemetry_MutationLifecycleReceiptEmitted::RunTest(const FString& /*Parameters*/)
{
	...
	// appended to FOsvayderUEExecutionLog. Agents filter on this fixed Tool
	...
	const FString ToolName = TEXT("osvayderue_lifecycle_test_telemetry");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[TestPackage]() -> FMCPToolResult
	...
	const int32 ReceiptCountBefore = FOsvayderUEExecutionLog::Get().GetReceipts().Num();

	TSharedRef<FJsonObject> Params = MakeShared<FJsonObject>();
	const FMCPToolResult Result = Registry.ExecuteTool(ToolName, Params);
	TestTrue(TEXT("tool should succeed"), Result.bSuccess);

	const TArray<FExecutionReceipt>& ReceiptsAfter = FOsvayderUEExecutionLog::Get().GetReceipts();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Packet676.AlreadyDirtyTouchedPackage_IsSavedAndReported",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Packet676_AlreadyDirtyTouchedPackage_IsSavedAndReported::RunTest(const FString& /*Parameters*/)
{
	...
	FMCPToolRegistry Registry;
	const FString ToolName = TEXT("osvayderue_packet676_already_dirty");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[TestPackage]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Packet676.AutoSaveFalseReportsSkippedNotSaved",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Packet676_AutoSaveFalseReportsSkippedNotSaved::RunTest(const FString& /*Parameters*/)
{
	...
	FMCPToolRegistry Registry;
	const FString ToolName = TEXT("osvayderue_packet676_autosave_false");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
		[TestPackage]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Packet676.UnrelatedDirtyPackage_NotSaved",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Packet676_UnrelatedDirtyPackage_NotSaved::RunTest(const FString& /*Parameters*/)
{
	...
	FMCPToolRegistry Registry;
	const FString ToolName = TEXT("osvayderue_packet676_unrelated_dirty");
	TSharedPtr<IMCPTool> Tool = MakeShared<FMockLifecycleTool>(
		ToolName,
		FMCPToolAnnotations::Modifying(),
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.Packet676.DirtyPackageLifecycleMatrix",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Packet676_DirtyPackageLifecycleMatrix::RunTest(const FString& /*Parameters*/)
{
	...
	const FString SandboxRoot = FString::Printf(TEXT("/Game/__OsvayderUETestSandbox/%s"), *RunId);
	...
	FMCPToolRegistry Registry;
	const FString AlreadyDirtyToolName = TEXT("osvayderue_packet676_matrix_already_dirty");
	...
	const FString AutoSaveFalseToolName = TEXT("osvayderue_packet676_matrix_autosave_false");
	Registry.RegisterTool(MakeShared<FMockLifecycleTool>(
	...
	const FString TargetOnlyToolName = TEXT("osvayderue_packet676_matrix_unrelated_dirty");
	Registry.RegisterTool(MakeShared<FMockLifecycleTool>(
		TargetOnlyToolName,
		FMCPToolAnnotations::Modifying(),
		[TargetPackage]() -> FMCPToolResult
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.FinalPracticalGauntlet.Packet677.DomainSmokeAndMiniFeatureE2E",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FMCPSavePipeline_Packet677_FinalPracticalGauntlet::RunTest(const FString& /*Parameters*/)
{
	...
	const FString SandboxRoot = FString::Printf(TEXT("/Game/__OsvayderUETestSandbox/%s"), *RunId);
	const FString SandboxContentDir = FPaths::Combine(FPaths::ProjectContentDir(), TEXT("__OsvayderUETestSandbox"), RunId);
	...
	}
	{
		...
		const FMCPToolResult Result = RecordTool(
			...
			{},
			true,
			TEXT("Read current execution log status as report/export equivalent without writing Saved/OsvayderUE reports."));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.ToolSchema_AutoSaveParameter_DeclaredForModifyingTools",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MutationLifecycle.ToolSchema_AutoSaveParameter_RealToolNameSpotCheck",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

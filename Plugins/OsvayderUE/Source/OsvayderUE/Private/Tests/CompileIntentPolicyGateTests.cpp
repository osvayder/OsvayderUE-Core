 ...
 *   A-P3-11 P2 helpers are reused (inherit from OsvayderUE::CommandClassification
 *           namespace; not duplicated inside the gate).
 *
 * Test grouping:
 *   - `OsvayderUE.CompileIntent.PolicyGate.*` -- direct gate decision tests.
 *   - `OsvayderUE.CompileIntent.Json.*` -- JSON shape verification.
 *   - `OsvayderUE.CompileIntent.Helpers.*` -- user-intent scan, enum-string.
 *
 * Reference:
 *   - Dispatch: `AgentBridge/CODEX_TO_OSVAYDER.md` 2026-04-19 17:35.
 *   - Spec:     `Docs/OsvayderUE/626_CompileRoutingAndErrorSafetyCorrection_DispatchReady_v3.md` §626-P3.
 */
...
namespace OsvayderUECompileIntentTestsDetail
{
...
using namespace OsvayderUECompileIntentTestsDetail;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.BodyEditShellBuildEditorOpen_DeniesAndRedirectsToLiveCoding",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.ReflectedHeaderShellBuildEditorOpen_DeniesAndRedirectsToRestartSurvival",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.BodyEditShellBuildEditorClosed_Allows",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.BodyEditShellBuildExpertLane_Allows",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.InspectionCommand_AlwaysAllows",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FCompileIntent_InspectionCommand_AlwaysAllows::RunTest(const FString& /*Parameters*/)
{
	...
	const TArray<FString> InspectionCommands = {
		TEXT("Get-Content D:/Project/Plugins/OsvayderUE/Source/Foo.cpp"),
		TEXT("rg \"UPROPERTY\" Plugins/OsvayderUE/Source/"),
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.AmbiguousChange_NoAutoEscalation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.UserIntentOverride_RebuildEverything_Allows",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.Json.RedirectResponseShape_MachineParseable",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.Json.TelemetryFields_AllTenEmitted",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.StructuredDenyPreservesAgentReasoningChain",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.Edge.MalformedCommand_EmptyString",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.Edge.NonCommandExecutionTool_AlwaysAllow",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.Edge.MetaOnlyUpropertyEdit_RedirectsToLiveCoding",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.Edge.NonCppChange_RedirectsToLiveCodingDiagnostic",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.PolicyGate.Edge.PowerShellWrappedBuild_EditorOpen_Denies",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.Helpers.HasUserIntentRebuildOverride",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.Helpers.CommandClassToString_AllValuesMapped",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

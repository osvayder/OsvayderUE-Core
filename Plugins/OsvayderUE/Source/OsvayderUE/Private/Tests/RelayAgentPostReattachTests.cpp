...
/**
 * 619 P3 tests for FOsvayderUERelayAgentManager::LoadActivePlanWithFallback.
 *
 * Covers spec Test plan `OsvayderUE.RelayAgent.PostReattach.*`:
...
namespace OsvayderUE::RelayAgentPostReattachTests
{
...
using namespace OsvayderUE::RelayAgentPostReattachTests;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.RelayAgent.PostReattach.ReadsActivePlanJson_WhenPresent",
...
bool FRelayAgent_PostReattach_ReadsActivePlanJson_WhenPresent::RunTest(const FString& /*Parameters*/)
{
	...
	FOsvayderUERelayAgentManager::EActivePlanFallbackSource Source
		= FOsvayderUERelayAgentManager::EActivePlanFallbackSource::NoneRecoverable;
	FString Error;
	const bool bLoaded = FOsvayderUERelayAgentManager::LoadActivePlanWithFallback(
	...
	TestEqual(TEXT("Source should be ActivePlanJson"),
		...
		static_cast<int32>(FOsvayderUERelayAgentManager::EActivePlanFallbackSource::ActivePlanJson));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.RelayAgent.PostReattach.FallsBackToStateJson_WhenActivePlanMissing",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FRelayAgent_PostReattach_FallsBackToStateJson_WhenActivePlanMissing::RunTest(const FString& /*Parameters*/)
{
	...
	TestEqual(
		...
		static_cast<int32>(Source),
		static_cast<int32>(FOsvayderUERelayAgentManager::EActivePlanFallbackSource::RestartSurvivalStateJsonFallback));
	TestEqual(
...
// so the widget does NOT route to [failed] at OsvayderEditorWidget.cpp:3661.
// ------------------------------------------------------------------------

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FRelayAgent_PostReattach_GracefulWarning_WhenBothMissing_DoesNotFailWidget,
	"OsvayderUE.RelayAgent.PostReattach.GracefulWarning_WhenBothMissing_DoesNotFailWidget",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FRelayAgent_PostReattach_GracefulWarning_WhenBothMissing_DoesNotFailWidget::RunTest(const FString& /*Parameters*/)
{
	...
	// at OsvayderEditorWidget.cpp:1260 is NEVER entered, and the [failed] UI at :3661
	// does NOT render.
	TestTrue(
	...
	TestEqual(
		...
		static_cast<int32>(Source),
		static_cast<int32>(FOsvayderUERelayAgentManager::EActivePlanFallbackSource::NoneRecoverable));

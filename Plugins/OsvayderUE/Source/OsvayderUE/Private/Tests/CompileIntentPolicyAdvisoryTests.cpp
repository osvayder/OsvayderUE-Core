 ...
 *   - `FOsvayderCodeSubsystem::SetPendingPolicyRoutingAdvisory` / orchestrator
 *     internals (cache API shape).
 *
 * Reference:
 *   - Dispatch: `AgentBridge/CODEX_TO_OSVAYDER.md` 2026-04-19 19:00 (P6-prep).
 *   - Spec:     v3 §626-P6.
 */
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.Advisory.EmptyForAllowDecision",
...
bool FCompileIntentAdvisory_EmptyForAllowDecision::RunTest(const FString& /*Parameters*/)
{
	...
	In.ToolCommandText = TEXT("Get-Content Plugins/OsvayderUE/Source/Foo.cpp");
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.Advisory.DenyWithRedirect_ContainsRequiredMarkers",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.Advisory.RequireRestart_PointsAtRestartSurvival",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.CompileIntent.Advisory.Ambiguous_PointsAtCppReflectionPreview",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.GetScreenshotDirectory.ReturnsValidPath",
...
bool FClipboardImage_GetScreenshotDirectory_ReturnsValidPath::RunTest(const FString& Parameters)
{
	...
	TestTrue("Should contain OsvayderUE", Dir.Contains(TEXT("OsvayderUE")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.Cleanup.DeletesOldFiles",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_Cleanup_DeletesOldFiles::RunTest(const FString& Parameters)
{
	...
	FString TestDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("OsvayderUE"), TEXT("test_screenshots"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.Cleanup.IgnoresNonClipboardFiles",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_Cleanup_IgnoresNonClipboardFiles::RunTest(const FString& Parameters)
{
	FString TestDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("OsvayderUE"), TEXT("test_screenshots2"));
	IFileManager::Get().MakeDirectory(*TestDir, true);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.Cleanup.HandlesNonExistentDirectory",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.Constants.ReasonableValues",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_Constants_ReasonableValues::RunTest(const FString& Parameters)
{
	TestTrue("MaxScreenshotAgeSeconds should be positive",
		OsvayderUEConstants::ClipboardImage::MaxScreenshotAgeSeconds > 0.0);

	TestTrue("MaxScreenshotAgeSeconds should be at least 60 seconds",
		OsvayderUEConstants::ClipboardImage::MaxScreenshotAgeSeconds >= 60.0);

	TestTrue("ThumbnailSize should be positive",
		OsvayderUEConstants::ClipboardImage::ThumbnailSize > 0.0f);

	TestTrue("ThumbnailSize should be reasonable (16-256px)",
		OsvayderUEConstants::ClipboardImage::ThumbnailSize >= 16.0f &&
		OsvayderUEConstants::ClipboardImage::ThumbnailSize <= 256.0f);

	TestTrue("ScreenshotSubdirectory should not be null",
		OsvayderUEConstants::ClipboardImage::ScreenshotSubdirectory != nullptr);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.DataStructs.RequestConfigHasImagePaths",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_RequestConfig_HasAttachedImagePaths::RunTest(const FString& Parameters)
{
	FOsvayderRequestConfig Config;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.DataStructs.PromptOptionsHasImagePaths",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.DataStructs.ConvenienceConstructorPreservesDefaults",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_PromptOptions_ConvenienceConstructor::RunTest(const FString& Parameters)
{
	FOsvayderPromptOptions Options(true, false);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.PathValidation.ScreenshotDirIsUnderSaved",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.ClipboardHasImage.DoesNotCrash",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.ParseResultMessage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.FallbackToAssistantBlocks",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.HandleEmptyOutput",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.HandleMalformedJson",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.BuildPayloadWithImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.BuildPayloadRejectsInvalidPath",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.BuildPayloadWithoutImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.BuildPayloadRejectsTraversal",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.BuildPayloadRejectsOversizedImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.StreamJson.ParseFailureReturnsErrorMessage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.MultiImage.BuildPayloadWithMultipleImages",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.MultiImage.BuildPayloadRespectsMaxCount",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_MultiImage_BuildPayloadRespectsMaxCount::RunTest(const FString& Parameters)
{
	...
	TestEqual("Should have 6 content blocks (1 text + 5 images, capped)",
		BlockCount, 1 + OsvayderUEConstants::ClipboardImage::MaxImagesPerMessage);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.MultiImage.BuildPayloadSkipsInvalidImages",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.MultiImage.BuildPayloadTotalSizeGuard",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.MultiImage.BuildPayloadMixedValidation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.MultiImage.ConstantsMaxImagesReasonable",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.MultiImage.RequestConfigArrayOperations",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClipboardImage.MultiImage.PromptOptionsArrayCopied",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_MultiImage_PromptOptionsArrayCopied::RunTest(const FString& Parameters)
{
	FOsvayderPromptOptions Original;
	...
	// Copy
	FOsvayderPromptOptions Copy = Original;

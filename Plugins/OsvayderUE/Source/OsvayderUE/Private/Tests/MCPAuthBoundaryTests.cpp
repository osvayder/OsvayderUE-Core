...
namespace
{
	...
	FHttpServerRequest MakePacket690Request(const FString& Token = FString())
	{
		...
		if (!Token.IsEmpty())
		{
			Request.Headers.Add(TEXT("X-OsvayderUE-MCP-Token"), { Token });
		}
		return Request;
	}
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.AuthBoundary.MissingTokenRejectsAndAudits",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.AuthBoundary.InvalidTokenRejectsAndAudits",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.AuthBoundary.ValidTokenAllowsReadOnlyFixture",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.AuthBoundary.ExpertHighRiskDeniedWithoutArmedState",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.AuthBoundary.ExpertDeniedAttemptAuditNoSecret",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

...
namespace
{
	struct FScopedDictationLanguageOverride
	{
		...
		explicit FScopedDictationLanguageOverride(const EOsvayderUEDictationLanguage NewLanguage)
		{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.VoiceDictation.LanguageSupport.ProjectDefaultRussian",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.VoiceDictation.LanguageSupport.EnglishOverrideMapsToEnglishModel",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FVoiceDictation_EnglishOverrideMapsToEnglishModel::RunTest(const FString& Parameters)
{
	FScopedDictationLanguageOverride DictationLanguageOverride(EOsvayderUEDictationLanguage::EnglishUs);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.VoiceDictation.LanguageSupport.PluginSettingsReadback",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FVoiceDictation_PluginSettingsExposeLanguageAndModelReadback::RunTest(const FString& Parameters)
{
	FScopedDictationLanguageOverride DictationLanguageOverride(EOsvayderUEDictationLanguage::RussianRu);

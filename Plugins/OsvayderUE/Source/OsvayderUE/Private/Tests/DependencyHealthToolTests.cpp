...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.DependencyHealth.Registry.ToolsRegistered",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.DependencyHealth.ClassifyHistoricalMountIssue",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.DependencyHealth.ClassifyCurrentScriptPackages",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.DependencyHealth.ExportReportArtifact",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDependencyHealth_ClassifyDemoteOrDeferFixture,
	"OsvayderUE.DependencyHealth.ClassifyDemoteOrDeferFixture",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

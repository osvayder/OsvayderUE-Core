...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FOsvayderUERecipeRegistry_InteractionAccessContractResolves,
	"OsvayderUE.RecipeRegistry.InteractionAccessContract.ResolvesSchemaAndObligations",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FOsvayderUERecipeRegistry_UnknownRecipeLookupFailsClosed,
	"OsvayderUE.RecipeRegistry.UnknownRecipeLookupFailsClosed",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FOsvayderUERecipeRegistry_InteractionAccessContractResolves::RunTest(const FString& Parameters)
{
	FOsvayderUERecipeEvidenceContract Contract;
	const bool bResolved = OsvayderUERecipeRegistry::TryGetRecipeEvidenceContract(
	...
	TestTrue(TEXT("contract should list focused registry test"),
		Contract.RequiredFocusedTests.Contains(TEXT("OsvayderUE.RecipeRegistry.InteractionAccessContract")));
...
bool FOsvayderUERecipeRegistry_UnknownRecipeLookupFailsClosed::RunTest(const FString& Parameters)
{
	FOsvayderUERecipeEvidenceContract Contract;
	const bool bResolved = OsvayderUERecipeRegistry::TryGetRecipeEvidenceContract(

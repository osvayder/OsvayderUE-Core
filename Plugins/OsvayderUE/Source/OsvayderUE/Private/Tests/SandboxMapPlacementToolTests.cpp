...
namespace
{
	...
	FString MakePacket691MapPath(const FString& TestName)
	{
		return FString::Printf(
			TEXT("/Game/__OsvayderUETestSandbox/packet691_%s_%s/M_Packet691_%s"),
			*TestName,
	...
	{
		return FString::Printf(
			TEXT("/Game/__OsvayderUETestSandbox/packet692_%s_%s/M_Packet692_%s"),
			*TestName,
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.SandboxMapPlacement.Registry.ToolRegistered",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.SandboxMapPlacement.Guardrails.RejectsNonSandboxMapPath",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.SandboxMapPlacement.Guardrails.RejectsRawDiskAndTraversalPaths",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FSandboxMapPlacement_RejectsRawDiskAndTraversalPaths::RunTest(const FString& Parameters)
{
	...
	{
		TSharedRef<FJsonObject> Params = MakeShared<FJsonObject>();
		Params->SetStringField(TEXT("map_path"), TEXT("/Game/__OsvayderUETestSandbox/packet691_bad/../M_Bad"));
		const FMCPToolResult Result = Tool.Execute(Params);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.SandboxMapPlacement.Guardrails.AcceptsCurrentPacketSandboxNamespace",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.SandboxMapPlacement.Positive.CreateOpenPlaceReadbackSave",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.SandboxMapPlacement.Lifecycle.ExplicitLevelSaveUsesUmap",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FSandboxMapPlacement_SavePipelineExplicitLevelUsesUmap::RunTest(const FString& Parameters)
{
	...
	const OsvayderUE::SavePipeline::FLifecycleOutcome Outcome = OsvayderUE::SavePipeline::Run(Spec);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.SandboxMapPlacement.Practical.RuntimeProofForPlacedSandboxMap",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

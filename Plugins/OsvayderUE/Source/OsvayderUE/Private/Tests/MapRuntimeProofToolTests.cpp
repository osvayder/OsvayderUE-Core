...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MapRuntimeProof.Registry.ToolsRegistered",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MapRuntimeProof.MissingMapProducesBoundedLimitation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MapRuntimeProof.HeadlessLoadExportReport",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

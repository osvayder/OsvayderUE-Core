...
namespace OsvayderSessionManagerTests
{
	...
	struct FScopedClaudePersistentSessionToggle
	{
		...
		EOsvayderUEDictationLanguage OriginalLanguage = EOsvayderUEDictationLanguage::Auto;
		FString OriginalModel;
		EOsvayderUEClaudeEffortLevel OriginalEffort = EOsvayderUEClaudeEffortLevel::Default;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClaudeSession.GetOrCreate_FirstCall_CreatesUuidAndArtifact",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FClaudeSession_GetOrCreate_FirstCall_CreatesUuidAndArtifact::RunTest(const FString& Parameters)
{
	using namespace OsvayderSessionManagerTests;
	...
	const FString Id = Manager.GetOrCreatePersistentSessionId(EOsvayderUEProviderBackend::ClaudeCli, Model, &bWasExisting);
	...
	const FString ArtifactPath = Manager.GetPersistentSessionFilePath(EOsvayderUEProviderBackend::ClaudeCli);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClaudeSession.GetOrCreate_SecondCall_ReturnsSameUuid",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_GetOrCreate_SecondCall_ReturnsSameUuid::RunTest(const FString& Parameters)
{
	...
	const FString IdFirst = Manager.GetOrCreatePersistentSessionId(EOsvayderUEProviderBackend::ClaudeCli, Model, &bWasExistingFirst);
	...
	const FString IdSecond = Manager.GetOrCreatePersistentSessionId(EOsvayderUEProviderBackend::ClaudeCli, Model, &bWasExistingSecond);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClaudeSession.ModelChange_InvalidatesSession",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_ModelChange_InvalidatesSession::RunTest(const FString& Parameters)
{
	...
	const FString IdA = Manager.GetOrCreatePersistentSessionId(EOsvayderUEProviderBackend::ClaudeCli, ModelA);
	TestFalse(TEXT("first id (model A) non-empty"), IdA.IsEmpty());

	bool bWasExistingAfterChange = true;
	const FString IdB = Manager.GetOrCreatePersistentSessionId(EOsvayderUEProviderBackend::ClaudeCli, ModelB, &bWasExistingAfterChange);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClaudeSession.ResetPersistentSession_DeletesArtifact",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_ResetPersistentSession_DeletesArtifact::RunTest(const FString& Parameters)
{
	...
	FOsvayderSessionManager Manager;
	const FString Id = Manager.GetOrCreatePersistentSessionId(EOsvayderUEProviderBackend::ClaudeCli, TEXT("claude-opus-4-7"));
	...
	Manager.ResetPersistentSession(EOsvayderUEProviderBackend::ClaudeCli);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.BuildCommandLine_IncludesSessionIdOnFirstRun",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_BuildCommandLine_IncludesSessionIdOnFirstRun::RunTest(const FString& Parameters)
{
	...
	const FString Fragment = FOsvayderCodeRunner::ComposePersistentSessionFlags(true, TestId, false);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.BuildCommandLine_IncludesResumeWhenArtifactExists",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_BuildCommandLine_IncludesResumeWhenArtifactExists::RunTest(const FString& Parameters)
{
	...
	const FString Fragment = FOsvayderCodeRunner::ComposePersistentSessionFlags(true, TestId, true);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.BuildCommandLine_OmitsSessionFlagsWhenSettingDisabled",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_BuildCommandLine_OmitsSessionFlagsWhenSettingDisabled::RunTest(const FString& Parameters)
{
	...
	const FString FragmentOff = FOsvayderCodeRunner::ComposePersistentSessionFlags(false, TestId, true);
	TestTrue(TEXT("fragment must be empty when persistent session is disabled"), FragmentOff.IsEmpty());

	const FString FragmentEmptyId = FOsvayderCodeRunner::ComposePersistentSessionFlags(true, FString(), true);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.AgentPromptContract.MaterializeClaudeSystemPrompt_AppendsLanguageLineWhenEnabled",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.AgentPromptContract.MaterializeClaudeSystemPrompt_NoLanguageLineWhenDisabled",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.BuildCommandLine_AppendsLanguageSystemPromptOnResume",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_BuildCommandLine_AppendsLanguageSystemPromptOnResume::RunTest(const FString& Parameters)
{
	...
	const FString ResumeFragment = FOsvayderCodeRunner::ComposePersistentSessionFlags(true, TestId, /*bWasExisting=*/true);
	const FString LanguageFragment = FOsvayderCodeRunner::ComposeLanguageHintFlag(TEXT("Russian"));
	...
	const FString EmptyLanguage = FOsvayderCodeRunner::ComposeLanguageHintFlag(FString());
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClaudeSession.ComputeClaudeNativeProjectKey_EncodesDriveAndSlashes",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_ComputeClaudeNativeProjectKey_EncodesDriveAndSlashes::RunTest(const FString& Parameters)
{
	...
	// Claude CLI mapping: X:/PublicExample/Unreal/SampleProject -> X--PublicExample-Unreal-SampleProject
	// (`:` -> `--`, `/` and `\` -> `-`, trailing slash/backslash dropped, drive-letter case preserved).
	const FString ExpectedSampleProjectKey = TEXT("X--PublicExample-Unreal-SampleProject");

	TestEqual(TEXT("forward-slash input encodes to the observed Claude CLI project key"),
		FOsvayderSessionManager::ComputeClaudeNativeProjectKey(TEXT("X:/PublicExample/Unreal/SampleProject")),
		ExpectedSampleProjectKey);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.ClaudeSession.ResetPersistentSession_DeletesMatchingNativeJsonl",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_ResetPersistentSession_DeletesMatchingNativeJsonl::RunTest(const FString& Parameters)
{
	...
	// FOsvayderUEScopePolicy allows writes (Saved/OsvayderUE is classified as internal_state).
	...
	const FString TargetUuid = Manager.GetOrCreatePersistentSessionId(
		EOsvayderUEProviderBackend::ClaudeCli, Model, &bWasExistingSeed);
	...
	const FString ProjectKey = FOsvayderSessionManager::ComputeClaudeNativeProjectKey(ProjectRoot);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.HandleResume400_InvalidRequest_TriggersAutoReset",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_HandleResume400_InvalidRequest_TriggersAutoReset::RunTest(const FString& Parameters)
{
	...
	const FString Sandbox = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("OsvayderUE"), TEXT("TestSandbox_ResetOn400"));
	...
	const FString InitialUuid = Manager.GetOrCreatePersistentSessionId(
		EOsvayderUEProviderBackend::ClaudeCli, TEXT("claude-opus-4-7"), &bWasExistingSeed);
	...
	TestTrue(TEXT("ShouldAutoResetOnExit must fire on 400 invalid_request_error when --resume was used"),
		FOsvayderCodeRunner::ShouldAutoResetOnExit(/*ExitCode=*/1, Simulated400, /*bUsedResume=*/true));
	...
	TestFalse(TEXT("ShouldAutoResetOnExit must NOT fire on 400 invalid_request_error when --resume was NOT used"),
		FOsvayderCodeRunner::ShouldAutoResetOnExit(/*ExitCode=*/1, Simulated400, /*bUsedResume=*/false));
	...
	TestFalse(TEXT("ShouldAutoResetOnExit must NOT fire on exit=0 regardless of output"),
		FOsvayderCodeRunner::ShouldAutoResetOnExit(/*ExitCode=*/0, Simulated400, /*bUsedResume=*/true));
	...
	const FString NewUuid = Manager.GetOrCreatePersistentSessionId(
		EOsvayderUEProviderBackend::ClaudeCli, TEXT("claude-opus-4-7"), &bWasExistingAfterReset);
	...
	const FString StoredAfterReset = Manager.ReadPersistentSessionId(EOsvayderUEProviderBackend::ClaudeCli);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.BuildCommandLine_ForwardsConfiguredModel",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_BuildCommandLine_ForwardsConfiguredModel::RunTest(const FString& Parameters)
{
	...
	const FString OpusFragment = FOsvayderCodeRunner::ComposeModelFlag(TEXT("claude-opus-4-7"));
	...
	const FString EmptyFragment = FOsvayderCodeRunner::ComposeModelFlag(FString());
	TestTrue(TEXT("empty model name must produce empty fragment"), EmptyFragment.IsEmpty());

	const FString WhitespaceFragment = FOsvayderCodeRunner::ComposeModelFlag(TEXT("   "));
	TestTrue(TEXT("whitespace-only model name must produce empty fragment"), WhitespaceFragment.IsEmpty());

	const FString TrimmedFragment = FOsvayderCodeRunner::ComposeModelFlag(TEXT("  claude-opus-4-7  "));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.BuildStdinPayload_IsPlainTextAfterP1Fix",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_BuildStdinPayload_IsPlainTextAfterP1Fix::RunTest(const FString& Parameters)
{
	...
	const FString Payload = FOsvayderCodeRunner::ComposeStdinPayloadForClaudePrint(TEXT("hello"));
	...
	const FString AlreadyTerminated = FOsvayderCodeRunner::ComposeStdinPayloadForClaudePrint(TEXT("hello\n"));
	...
	const FString EmptyPayload = FOsvayderCodeRunner::ComposeStdinPayloadForClaudePrint(FString());
	...
	const FString RussianPayload = FOsvayderCodeRunner::ComposeStdinPayloadForClaudePrint(TEXT("Запомни число 42."));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.ParseStreamJsonOutput_HandlesCurrentCliStdoutShape",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.BuildCommandLine_EndToEndShapeLooksSane",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_BuildCommandLine_EndToEndShapeLooksSane::RunTest(const FString& Parameters)
{
	...
	Shape += FOsvayderCodeRunner::ComposePersistentSessionFlags(true, TestUuid, /*bWasExisting=*/true);
	Shape += FOsvayderCodeRunner::ComposeLanguageHintFlag(Language);
	Shape += FOsvayderCodeRunner::ComposeModelFlag(Model);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.ComposeEffortFlag_EmitsExpectedFragments",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_ComposeEffortFlag_EmitsExpectedFragments::RunTest(const FString& Parameters)
{
	...
	TestTrue(TEXT("empty level → empty fragment (Default setting ⇒ CLI default applies)"),
		FOsvayderCodeRunner::ComposeEffortFlag(FString()).IsEmpty());
	TestTrue(TEXT("whitespace-only level → empty fragment"),
		FOsvayderCodeRunner::ComposeEffortFlag(TEXT("   ")).IsEmpty());

	TestEqual(TEXT("low fragment"),
		FOsvayderCodeRunner::ComposeEffortFlag(TEXT("low")), FString(TEXT("--effort low ")));
	TestEqual(TEXT("medium fragment"),
		FOsvayderCodeRunner::ComposeEffortFlag(TEXT("medium")), FString(TEXT("--effort medium ")));
	TestEqual(TEXT("high fragment"),
		FOsvayderCodeRunner::ComposeEffortFlag(TEXT("high")), FString(TEXT("--effort high ")));
	TestEqual(TEXT("xhigh fragment"),
		FOsvayderCodeRunner::ComposeEffortFlag(TEXT("xhigh")), FString(TEXT("--effort xhigh ")));
	TestEqual(TEXT("max fragment"),
		FOsvayderCodeRunner::ComposeEffortFlag(TEXT("max")), FString(TEXT("--effort max ")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.OsvayderCodeRunner.BuildCommandLine_ForwardsConfiguredEffort",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FClaudeSession_BuildCommandLine_ForwardsConfiguredEffort::RunTest(const FString& Parameters)
{
	...
	if (!Settings)
	{
		AddError(TEXT("UOsvayderUESettings::GetMutable returned null — cannot exercise BuildCommandLine shape."));
		return false;
	}

	// Non-default (Max) — expect `--effort max` in the synthesized shape.
	Settings->DefaultClaudeEffortLevel = EOsvayderUEClaudeEffortLevel::Max;
	...
	MaxShape += FOsvayderCodeRunner::ComposeModelFlag(TEXT("claude-opus-4-7"));
	MaxShape += FOsvayderCodeRunner::ComposeEffortFlag(MaxLevel);
	...
	Settings->DefaultClaudeEffortLevel = EOsvayderUEClaudeEffortLevel::Default;
	...
	DefaultShape += FOsvayderCodeRunner::ComposeModelFlag(TEXT("claude-opus-4-7"));
	DefaultShape += FOsvayderCodeRunner::ComposeEffortFlag(DefaultLevel);

...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.UnknownOps.AI.FormatAndValidList",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.UnknownOps.Multiplayer.FormatAndValidList",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.UnknownOps.Niagara.FormatAndValidList",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.UnknownOps.Sequencer.FormatAndValidList",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.UnknownOps.AnimBlueprintModify.FormatAndValidList",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.UnknownOps.CppReflection.FormatAndValidList",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"OsvayderUE.MCP.Tools.ErrorResult.StructuredFailureData",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

...
/**
 * Constants used throughout the Osvayder UE plugin
 * Centralizes magic numbers and configuration values
 */
namespace OsvayderUEConstants
{
	// Process and I/O
	namespace Process
	{
	...
	namespace ClipboardImage
	{
		...
		/** Subdirectory under Saved/OsvayderUE/ for clipboard screenshots */
	...
	{
		/** Saved/OsvayderUE subdirectory for bounded audio artifacts and runtime data */
		...
		inline constexpr const TCHAR* PythonEnvOverrideVar = TEXT("OSVAYDERUE_DICTATION_PYTHON");

		/** Optional debug WAV override used only for bounded practical verification */
		inline constexpr const TCHAR* DebugFixtureEnvVar = TEXT("OSVAYDERUE_DICTATION_DEBUG_WAV");
	}
}

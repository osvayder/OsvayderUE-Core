...
OSVAYDERUE_API const TCHAR* AgentCapabilityFamilyModeToString(EAgentCapabilityFamilyMode Mode);

struct OSVAYDERUE_API FAgentCapabilityRiskFamilyManifest
{
	FString FamilyId;
	FString DisplayName;
	FString Purpose;
...
struct OSVAYDERUE_API FAgentCapabilityRiskToolMapping
{
	FString ToolName;
...
struct OSVAYDERUE_API FAgentCapabilityRiskToolCoverageBucket
{
	FString BucketId;
	FString DisplayName;
...
struct OSVAYDERUE_API FAgentCapabilityRiskToolCoverageManifest
{
...
struct OSVAYDERUE_API FAgentCapabilityRiskySurfaceCoverageBucket
{
	FString BucketId;
	FString DisplayName;
...
struct OSVAYDERUE_API FAgentCapabilityRiskySurfaceLaneBehavior
{
...
struct OSVAYDERUE_API FAgentCapabilityRiskySurfaceEntry
{
	FString ToolName;
	FString SurfaceIdentifier;
	FString SurfaceKind;
...
struct OSVAYDERUE_API FAgentCapabilityRiskySurfaceCoverageManifest
{
...
struct OSVAYDERUE_API FAgentCppScopeCategoryManifest
{
	FString CategoryId;
	FString DisplayName;
	FString ScopeState;
...
struct OSVAYDERUE_API FAgentCppScopeDefinitionManifest
{
...
struct OSVAYDERUE_API FAgentCapabilityRiskToolMappingManifest
{
...
struct OSVAYDERUE_API FAgentCapabilityRiskManifest
{
...
OSVAYDERUE_API FAgentCapabilityRiskManifest BuildAgentCapabilityRiskManifest(
...
OSVAYDERUE_API TSharedPtr<FJsonObject> MakeAgentCapabilityRiskManifestJson(

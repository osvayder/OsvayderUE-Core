...
struct OSVAYDERUE_API FAgentExecutionPowerLane
{
...
struct OSVAYDERUE_API FAgentExecutionLaneTaxonomyEntry
{
...
struct OSVAYDERUE_API FAgentExecutionProfileLaneMapping
{
...
struct OSVAYDERUE_API FAgentExecutionProviderTransportMatrixRow
{
	EAgentExecutionRuntimeLane Lane = EAgentExecutionRuntimeLane::ReadOnlyAnalysis;
...
struct OSVAYDERUE_API FAgentExecutionPolicyDenySchema
{
...
struct OSVAYDERUE_API FAgentExecutionPolicyDenyContract
{
	FString SchemaVersion = TEXT("policy_deny_contract_v1");
	FString ResultType = TEXT("policy_denied");
...
struct OSVAYDERUE_API FAgentExecutionSessionBoundaryRule
{
...
struct OSVAYDERUE_API FAgentExecutionSessionBoundaryManifest
{
...
struct OSVAYDERUE_API FAgentProviderExecutionControlManifest
{
...
OSVAYDERUE_API FAgentProviderExecutionControlManifest BuildAgentProviderExecutionControlManifest(
	const FAgentBackendStatus& Status,
	const FAgentRequestConfig& Config);

OSVAYDERUE_API bool TryBuildAgentExecutionPolicyDenyContract(
	const FAgentBackendStatus& Status,
	const FAgentRequestConfig& Config,
	const FString& RequestedAction,
	FAgentExecutionPolicyDenyContract& OutContract);

OSVAYDERUE_API bool TryParsePolicyDenyContractFromToolResultJson(
	const FString& ToolResultJson,
	FAgentExecutionPolicyDenyContract& OutContract);

OSVAYDERUE_API TSharedPtr<FJsonObject> MakeAgentExecutionPolicyDenyContractJson(
	const FAgentExecutionPolicyDenyContract& Contract);

OSVAYDERUE_API TSharedPtr<FJsonObject> MakeAgentProviderExecutionControlJson(

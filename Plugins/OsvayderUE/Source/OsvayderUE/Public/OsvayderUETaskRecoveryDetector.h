 ...
 */
struct OSVAYDERUE_API FTaskRecoveryDetectionResult
{
 ...
 */
class OSVAYDERUE_API FOsvayderUETaskRecoveryDetector
{
public:
	/**
	 * Invoked from FOsvayderUEModule::StartupModule() tail after the 628-v3
	...
	static FTaskRecoveryDetectionResult ClassifyPlan(
		...
		const TOptional<FOsvayderUERestartSurvivalState>& RestartSurvivalState = TOptional<FOsvayderUERestartSurvivalState>(),

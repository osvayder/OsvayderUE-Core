 ...
 */
struct OSVAYDERUE_API FOsvayderPromptOptions
{
	...
	FOnOsvayderStreamEvent OnStreamEvent;
	...
	FOsvayderPromptOptions() = default;

	/** Convenience constructor for common case */
	FOsvayderPromptOptions(bool bEngineContext, bool bProjectContext)
...
public:
	...
	IOsvayderRunner* GetRunner() const;

...
class OSVAYDERUE_API FCodexCliRunner : public IAgentBackend, public FRunnable
{
public:
	...
	virtual EOsvayderUEProviderBackend GetBackendType() const override { return EOsvayderUEProviderBackend::CodexCli; }

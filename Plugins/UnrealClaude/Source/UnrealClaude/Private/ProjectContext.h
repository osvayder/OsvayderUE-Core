...
/**
 * A project memory document that should be injected into Claude context
 */
struct FProjectMemoryDoc
{
	/** Project-relative file path */
	FString FilePath;

	/** Prompt-ready content (possibly truncated) */
	FString Content;

	/** Whether the content was truncated before injection */
...
struct FProjectContext
{
	...
	/** Curated project memory docs for agent context */
	TArray<FProjectMemoryDoc> MemoryDocs;
...
private:
	...
	/** Load curated project memory docs from Docs/UnrealClaude */
	void LoadProjectMemoryDocs();

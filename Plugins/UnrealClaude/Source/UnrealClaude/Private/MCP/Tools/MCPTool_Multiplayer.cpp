...
namespace
{
	...
	FUnrealClaudeReportTruthSummary BuildAuditTruthSummary(
...
FMCPToolInfo FMCPTool_Multiplayer::GetInfo() const
{
	...
	Info.Parameters = {
		...
		FMCPToolParameter(TEXT("export_report"), TEXT("boolean"),
			TEXT("For read-only audit operations, if true, persist a Markdown report and normalized sidecar under Saved/UnrealClaude/Reports."), false, TEXT("false")),

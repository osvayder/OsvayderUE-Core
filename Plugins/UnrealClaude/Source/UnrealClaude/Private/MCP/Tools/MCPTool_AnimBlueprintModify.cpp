...
FMCPToolResult FMCPTool_AnimBlueprintModify::Execute(const TSharedRef<FJsonObject>& Params)
{
	...
	return FMCPToolResult::Error(FString::Printf(
		TEXT("Unknown anim_blueprint_modify operation: '%s'. Valid: get_info, get_state_machine, ")
		TEXT("create_state_machine, add_state, remove_state, set_entry_state, add_transition, ")
		TEXT("remove_transition, set_transition_duration, set_transition_priority, add_condition_node, ")
		TEXT("delete_condition_node, connect_condition_nodes, connect_to_result, ")
		TEXT("connect_state_machine_to_output, set_state_animation, find_animations, batch, ")
		TEXT("get_transition_nodes, inspect_node_pins, set_pin_default_value, add_comparison_chain, ")
		TEXT("validate_blueprint, get_state_machine_diagram, setup_transition_conditions"),
		*Operation));
}

...
public:
	...
	/** Build an immediate policy-denied result when async submission targets a governed-denied surface */
	bool TryBuildSubmissionPolicyDenyResult(const FString& ToolName, const TSharedRef<FJsonObject>& Parameters, FMCPToolResult& OutResult) const;

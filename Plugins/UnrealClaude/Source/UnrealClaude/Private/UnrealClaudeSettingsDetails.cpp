...
#define LOCTEXT_NAMESPACE "UnrealClaudeSettingsDetails"
...
namespace
{
	...
	EUnrealClaudeCodexAuthMode GetAuthModeValue(const TSharedPtr<IPropertyHandle>& PropertyHandle)
	{
		if (!PropertyHandle.IsValid())
		{
			return EUnrealClaudeCodexAuthMode::Auto;
		}

		uint8 RawValue = 0;
		if (PropertyHandle->GetValue(RawValue) == FPropertyAccess::Success)
		{
			return static_cast<EUnrealClaudeCodexAuthMode>(RawValue);
		}

		return EUnrealClaudeCodexAuthMode::Auto;
	}

	EUnrealClaudeCodexWorkMode GetWorkModeValue(const TSharedPtr<IPropertyHandle>& PropertyHandle)
	{
		if (!PropertyHandle.IsValid())
		{
			return EUnrealClaudeCodexWorkMode::Balanced;
		}

		uint8 RawValue = 0;
		if (PropertyHandle->GetValue(RawValue) == FPropertyAccess::Success)
		{
			return static_cast<EUnrealClaudeCodexWorkMode>(RawValue);
		}
	...
	TAttribute<EVisibility> MakeAuthModeVisibility(
		...
		const EUnrealClaudeCodexAuthMode ExpectedMode,
	...
	TAttribute<EVisibility> MakeWorkModeNotCustomVisibility(const TSharedPtr<IPropertyHandle>& PropertyHandle)
	{
		...
		{
			return GetWorkModeValue(PropertyHandle) == EUnrealClaudeCodexWorkMode::Custom
...
TSharedRef<IDetailCustomization> FUnrealClaudeSettingsDetails::MakeInstance()
{
	return MakeShared<FUnrealClaudeSettingsDetails>();
}

void FUnrealClaudeSettingsDetails::CustomizeDetails(IDetailLayoutBuilder& DetailLayout)
{
	SortCategories(DetailLayout);

	const TSharedPtr<IPropertyHandle> PreferredBackend = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, PreferredBackend));
	const TSharedPtr<IPropertyHandle> ScopeMode = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, ScopeMode));
	const TSharedPtr<IPropertyHandle> AutoRestoreSession = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, bAutoRestoreSessionOnOpen));
	const TSharedPtr<IPropertyHandle> DictationLanguage = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultDictationLanguage));
	const TSharedPtr<IPropertyHandle> ClaudeModel = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultModel));
	const TSharedPtr<IPropertyHandle> ClaudeMaxTokens = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, MaxResponseTokens));
	const TSharedPtr<IPropertyHandle> ClaudePersistentSession = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, bClaudeUsePersistentSession));
	const TSharedPtr<IPropertyHandle> ClaudeForwardLanguage = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, bClaudeForwardLanguageToSystemPrompt));
	const TSharedPtr<IPropertyHandle> ClaudeEffortLevel = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultClaudeEffortLevel));
	const TSharedPtr<IPropertyHandle> CodexModel = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultCodexModel));
	const TSharedPtr<IPropertyHandle> CodexProfile = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultCodexProfile));
	const TSharedPtr<IPropertyHandle> CodexSpeedMode = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultCodexSpeedMode));
	const TSharedPtr<IPropertyHandle> CodexWorkMode = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultCodexWorkMode));
	const TSharedPtr<IPropertyHandle> CodexReasoning = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultCodexReasoningEffort));
	const TSharedPtr<IPropertyHandle> CodexVerbosity = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultCodexVerbosity));
	const TSharedPtr<IPropertyHandle> CodexAuthMode = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultCodexAuthMode));
	const TSharedPtr<IPropertyHandle> CodexApiEnvVar = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultCodexApiKeyEnvVar));
	const TSharedPtr<IPropertyHandle> CodexBrowserProxyClear = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, bCodexBrowserVerifyClearProxyEnv));
	const TSharedPtr<IPropertyHandle> CodexExecProxyClear = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, bCodexExecClearProxyEnv));
	const TSharedPtr<IPropertyHandle> CodexPersistentAppServer = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, bCodexUsePersistentAppServer));
	const TSharedPtr<IPropertyHandle> CodexHomeOverride = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, DefaultCodexHomeOverride));
	const TSharedPtr<IPropertyHandle> AutonomousMutationMode = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UUnrealClaudeSettings, bAutonomousMutationMode));
	...
	AddGroupHeader(
		...
		LOCTEXT("ClaudeRuntimeBody", "These options control how UnrealClaude keeps Claude CLI conversation memory alive across prompts and whether the system prompt carries a spoken-language directive."));
	...
	AddGroupHeader(
		...
		LOCTEXT("CodexBasicsBody", "Choose which Codex model and optional CLI profile UnrealClaude should use."));
	...
	AddInlineNote(
		...
		MakeAuthModeVisibility(CodexAuthMode, EUnrealClaudeCodexAuthMode::ApiKeyEnvVar, true));
	...
	AddInlineNote(
		...
		MakeAuthModeVisibility(CodexAuthMode, EUnrealClaudeCodexAuthMode::BrowserVerify, true));
	...
	AddGroupHeader(
		...
		LOCTEXT("CodexRuntimeBody", "These options control how UnrealClaude keeps Codex conversation state alive during ordinary use."));
...
void FUnrealClaudeSettingsDetails::AddGroupHeader(
...
void FUnrealClaudeSettingsDetails::AddInlineNote(
	IDetailCategoryBuilder& Category,
...
void FUnrealClaudeSettingsDetails::SortCategories(IDetailLayoutBuilder& DetailLayout)
{

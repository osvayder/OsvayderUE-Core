...
FUnrealClaudeTaskRecoveryDialog::FDialogResult
FUnrealClaudeTaskRecoveryDialog::Show(const FTaskRecoverySummary& Summary, const FString& DiagnosticNote)
{
	FDialogResult FallbackResult;
	FallbackResult.Choice = EUnrealClaudeTaskRecoveryChoice::None;
	...
	TSharedPtr<EUnrealClaudeTaskRecoveryChoice> ChoicePtr
		= MakeShared<EUnrealClaudeTaskRecoveryChoice>(EUnrealClaudeTaskRecoveryChoice::None);
	...
	TSharedRef<SWidget> Content = SNew(SVerticalBox)
		...
		[
			...
			[
				...
				{
					*ChoicePtr = EUnrealClaudeTaskRecoveryChoice::Continue;
					if (Window.IsValid())
					{
			...
			[
				...
				.OnClicked_Lambda([ChoicePtr, Window]()
				{
					*ChoicePtr = EUnrealClaudeTaskRecoveryChoice::StartFresh;
					if (Window.IsValid())
					{
						Window->RequestDestroyWindow();
					}
			...
			[
				...
				{
					*ChoicePtr = EUnrealClaudeTaskRecoveryChoice::CloseAsIrrelevant;
...
FString FUnrealClaudeTaskRecoveryContextBuilder::BuildContextBlockText(const FTaskRecoverySummary& Summary)
{

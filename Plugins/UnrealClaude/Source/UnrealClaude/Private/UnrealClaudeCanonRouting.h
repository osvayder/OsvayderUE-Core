...
struct FUnrealClaudeCanonLedgerEntry
{
	FString PatternKey;
	FString Subsystem;
	FString ShortTitle;
...
struct FUnrealClaudeCanonPromotionRequest
{
...
class FUnrealClaudeCanonLedger
{
public:
	static FString GetLedgerPath();
	static bool LoadEntries(TArray<FUnrealClaudeCanonLedgerEntry>& OutEntries, FString& OutError);
	static bool SaveEntries(const TArray<FUnrealClaudeCanonLedgerEntry>& Entries, FString& OutError);
	static bool PromoteEntry(const FUnrealClaudeCanonLedgerEntry& Entry, FString& OutError);
	static bool PromoteFromProvenRun(
		const FUnrealClaudeCanonPromotionRequest& Request,
		FString& OutError,
		FUnrealClaudeCanonLedgerEntry* OutPromotedEntry = nullptr);

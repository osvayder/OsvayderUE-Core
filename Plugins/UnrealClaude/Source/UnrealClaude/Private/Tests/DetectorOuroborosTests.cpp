 ...
 *
 * Reference:
 *   - Dispatch: `AgentBridge/CODEX_TO_CLAUDE.md` 2026-04-19 16:15.
 *   - Audit:    `Docs/UnrealClaude/626_P2_DetectorSourceAudit.md`.
 *   - Spec:     `Docs/UnrealClaude/626_CompileRoutingAndErrorSafetyCorrection_DispatchReady_v3.md` §P2 Layers A/B/C.
 *
...
namespace UnrealClaudeDetectorOuroborosTestsDetail
{
...
using namespace UnrealClaudeDetectorOuroborosTestsDetail;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.RestartSurvival.DetectorNegative.GrepOwnDetectorSource",
...
bool FDetectorNegative_GrepOwnDetectorSource::RunTest(const FString& /*Parameters*/)
{
	...
	const FString SimulatedRgOutput =
		  FString(TEXT("Plugins/UnrealClaude/Source/UnrealClaude/Private/UnrealClaudeRestartSurvival.cpp:453:\t\t\tif (Haystack.Contains(TEXT(\"")) + ComposeUhtRenameLockPhrase() + TEXT("\"))\n")
		+ TEXT("Plugins/UnrealClaude/Source/UnrealClaude/Private/UnrealClaudeRestartSurvival.cpp:461:\t\t\t\tTEXT(\"") + ComposeUhtRenameLockPhrase() + TEXT("\"));\n");

	FUnrealClaudeClosedEditorBuildBlocker Blocker;
	const bool bDetected = FUnrealClaudeRestartSurvivalManager::TryDetectClosedEditorBuildBlocker(
		TEXT("command_execution"),
		TEXT("rg \"Failed to rename\" Plugins/UnrealClaude/Source/"), // ToolInput: rg inspection
		SimulatedRgOutput,
		FString(),
		Blocker);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.RestartSurvival.DetectorNegative.ReadObservedFailures",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FDetectorNegative_ReadObservedFailures::RunTest(const FString& /*Parameters*/)
{
	...
	const bool bDetected = FUnrealClaudeRestartSurvivalManager::TryDetectClosedEditorBuildBlocker(
		TEXT("command_execution"),
		TEXT("Get-Content Docs/UnrealClaude/observed_failures.md"),
...
bool FDetectorNegative_ReadSavedRelayArtifact::RunTest(const FString& /*Parameters*/)
{
	...
	const bool bDetected = FUnrealClaudeRestartSurvivalManager::TryDetectClosedEditorBuildBlocker(
		TEXT("command_execution"),
		TEXT("Get-Content Saved/UnrealClaude/relay_prompt.txt"),
...
// Docs/UnrealClaude/*.md files. Path:line:content prefixes and
// excluded-origin match trip Layer B; Layer A rejects rg.
// ================================================================

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FDetectorNegative_RgSearchBlockerPhrase,
	"UnrealClaude.RestartSurvival.DetectorNegative.RgSearchBlockerPhrase",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

bool FDetectorNegative_RgSearchBlockerPhrase::RunTest(const FString& /*Parameters*/)
{
	const FString SimulatedRgOutput =
		  FString(TEXT("Docs/UnrealClaude/626_CompileRoutingAndErrorSafetyCorrection_DispatchReady_v3.md:142:  - ")) + ComposeUhtRenameLockPhrase() + TEXT("...\n")
		+ TEXT("Docs/UnrealClaude/observed_failures.md:88:Past blocker string: ") + ComposeUhtRenameLockPhrase() + TEXT("\n");

	FUnrealClaudeClosedEditorBuildBlocker Blocker;
	const bool bDetected = FUnrealClaudeRestartSurvivalManager::TryDetectClosedEditorBuildBlocker(
		TEXT("command_execution"),
		FString(TEXT("rg \"")) + ComposeUhtRenameLockPhrase() + TEXT("\" Docs/UnrealClaude/"),
		SimulatedRgOutput,
		FString(),
		Blocker);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.RestartSurvival.DetectorNegative.AgentReasoningMentionsBlocker",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FDetectorNegative_AgentReasoningMentionsBlocker::RunTest(const FString& /*Parameters*/)
{
	...
	const FString HarmlessFileListing =
		  FString(TEXT("Directory: D:\\Project\\Plugins\\UnrealClaude\\Source\\UnrealClaude\\Private\n"))
		+ TEXT("Mode                 LastWriteTime         Length Name\n")
		+ TEXT("-a---           2026-04-19    15:36         123456 ClaudeEditorWidget.cpp\n");

	FUnrealClaudeClosedEditorBuildBlocker Blocker;
	const bool bDetected = FUnrealClaudeRestartSurvivalManager::TryDetectClosedEditorBuildBlocker(
		TEXT("command_execution"),
		TEXT("Get-ChildItem Plugins/UnrealClaude/Source/UnrealClaude/Private"),
		HarmlessFileListing,
		ReasoningPayload,
		Blocker);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.RestartSurvival.DetectorPositive.UbtRenameLockOutput",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.RestartSurvival.DetectorPositive.LogBackupAccessDenied",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.RestartSurvival.DetectorPositive.LiveCodingUnableToBuild",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.RestartSurvival.DetectorPositive.IntermediateBuildFileLock",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

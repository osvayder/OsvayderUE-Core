...
namespace UnrealClaude::LiveCodingToolTests
{
	/**
	 * Scoped guard for UUnrealClaudeSettings::bAllowAutoEnableLiveCoding.
	...
	struct FScopedLiveCodingOverrides
	{
		...
		{
			UnrealClaude::LiveCodingCompile::Testing::ClearAllOverrides();
		}
	};
...
using namespace UnrealClaude::LiveCodingToolTests;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.Registered_VisibleInToolList",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.DispatchesToTriggerLiveCodingCompile",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FLiveCodingTool_DispatchesToTriggerLiveCodingCompile::RunTest(const FString& /*Parameters*/)
{
	...
	int32 CallCount = 0;
	UnrealClaude::LiveCodingCompile::Testing::SetIsEnabledForSessionOverride([]() { return true; });
	UnrealClaude::LiveCodingCompile::Testing::SetTriggerLiveCodingCompileOverride(
		[&CallCount]() -> UnrealClaude::LiveCodingCompile::Testing::FMockCompileResult
		{
			++CallCount;
			UnrealClaude::LiveCodingCompile::Testing::FMockCompileResult R;
			R.bSuccess = true;
			return R;
		});
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ReturnsSuccessWithRefreshStatus_OnPatchOK",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FLiveCodingTool_ReturnsSuccessWithRefreshStatus_OnPatchOK::RunTest(const FString& /*Parameters*/)
{
	...
	UnrealClaude::LiveCodingCompile::Testing::SetIsEnabledForSessionOverride([]() { return true; });
	UnrealClaude::LiveCodingCompile::Testing::SetTriggerLiveCodingCompileOverride(
		[]() -> UnrealClaude::LiveCodingCompile::Testing::FMockCompileResult
		{
			UnrealClaude::LiveCodingCompile::Testing::FMockCompileResult R;
			R.bSuccess = true;
			return R;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ReturnsFailureWithDiagnostics_OnCompileError",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ReportsDisabledForSession_WhenLiveCodingOff",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FLiveCodingTool_ReportsDisabledForSession_WhenLiveCodingOff::RunTest(const FString& /*Parameters*/)
{
	...
	UnrealClaude::LiveCodingCompile::Testing::SetIsEnabledForSessionOverride([]() { return false; });

	bool bTriggerCalled = false;
	UnrealClaude::LiveCodingCompile::Testing::SetTriggerLiveCodingCompileOverride(
		[&bTriggerCalled]() -> UnrealClaude::LiveCodingCompile::Testing::FMockCompileResult
		{
			bTriggerCalled = true;
			UnrealClaude::LiveCodingCompile::Testing::FMockCompileResult R;
			R.bSuccess = true;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.EnableForSession_WhenAutoEnableTrue",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FLiveCodingTool_EnableForSession_WhenAutoEnableTrue::RunTest(const FString& /*Parameters*/)
{
	...
	UnrealClaude::LiveCodingCompile::Testing::SetIsEnabledForSessionOverride(
		[&bEnabled]() { return bEnabled; });
	UnrealClaude::LiveCodingCompile::Testing::SetEnableForSessionOverride(
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.OnNonWindows_ReturnsPlatformError",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ConcurrentCall_PollsIsCompilingCorrectly",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FLiveCodingTool_ConcurrentCall_PollsIsCompilingCorrectly::RunTest(const FString& /*Parameters*/)
{
	...
	UnrealClaude::LiveCodingCompile::Testing::SetIsCompilingPollOverride(
	...
	UnrealClaude::LiveCodingCompile::Testing::SetTriggerLiveCodingCompileOverride(
		[&CompileCalls]() -> UnrealClaude::LiveCodingCompile::Testing::FMockCompileResult
		{
			++CompileCalls;
			UnrealClaude::LiveCodingCompile::Testing::FMockCompileResult R;
			R.bSuccess = true;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.AnnotationsMarkedModifying_NotDestructive",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

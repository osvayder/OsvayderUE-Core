 ...
 *
 * Reference: dispatch `AgentBridge/CODEX_TO_CLAUDE.md` 2026-04-20 01:15 (631).
 */
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.AgentSelfRetro.ResponseClaimStatusFull_ClassifierTruth",
...
bool FAgentSelfRetro_ResponseClaimStatusFull_ClassifierTruth::RunTest(const FString& /*Parameters*/)
{
	...
	TestTrue(TEXT("'Status: full' detected"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(TEXT("Status: full")));
	...
	TestTrue(TEXT("'result: full' detected"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(TEXT("result: full")));
	TestTrue(TEXT("Markdown '**Result**' + '`full`' detected"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(TEXT("**Result**\n\n`full`")));
	TestTrue(TEXT("Within a larger response body"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(
	...
	TestFalse(TEXT("Empty string: no claim"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(FString()));
	TestFalse(TEXT("'status: partial' must NOT match"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(TEXT("status: partial")));
	TestFalse(TEXT("'status: failed' must NOT match"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(TEXT("status: failed")));
	TestFalse(TEXT("'status: unverified_manual' must NOT match"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(TEXT("status: unverified_manual")));
	TestFalse(TEXT("'fully implemented' without status: prefix must NOT match"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(TEXT("fully implemented the feature")));
	TestFalse(TEXT("'full implementation' without status: prefix must NOT match"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(TEXT("full implementation of feature")));
	...
	TestFalse(TEXT("'status: fullscreen' must NOT match (word boundary guard)"),
		SClaudeEditorWidget::DoesResponseClaimStatusFull(TEXT("status: fullscreen mode enabled")));
...
namespace
{
	...
	{
		return FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealClaude"), TEXT("Automation"), TEXT("AgentSelfRetro"));
	}
}
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.AgentSelfRetro.Suggester_EmitsRecommendationForRepeatedPattern",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.AgentSelfRetro.Suggester_NoRecommendationForSingleEntry",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

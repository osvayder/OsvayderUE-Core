...
namespace
{
	...
	struct FScopedMetadataTruthMapsToCookFixture
	{
		...
		bool Initialize(FAutomationTestBase& Test)
		{
			...
			const FString DataTablePackagePath = FString::Printf(TEXT("/Game/UnrealClaudeAutomation/DT_MetadataTruth_%s"), *UniqueSuffix);
			...
			UpdatedDefaultGameIni += TEXT("\n[/Script/UnrealClaude.MetadataTruthAutomationFixture]\n");
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.MetadataTruth.Registry.ToolsRegistered",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.MetadataTruth.CompareExplicitBuckets",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.MetadataTruth.CompareLevelInfoTableToMapsToCook",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.MetadataTruth.ExportReportArtifact",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

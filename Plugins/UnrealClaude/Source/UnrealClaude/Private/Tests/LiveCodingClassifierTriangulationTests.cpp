 ...
 *
 * Reference:
 *   - Dispatch: `AgentBridge/CODEX_TO_CLAUDE.md` 2026-04-19 17:00.
 *   - Spec:     `Docs/UnrealClaude/626_CompileRoutingAndErrorSafetyCorrection_DispatchReady_v3.md` §626-P4.
 *   - Observed: `Docs/UnrealClaude/observed_failures.md` row #31 (UE 5.7 Cancelled-on-no-reinstance).
 */
...
using UnrealClaude::LiveCodingCompile::Testing::FLiveCodingTriangulationSignals;
using UnrealClaude::LiveCodingCompile::Testing::FLiveCodingNoChangeDiagnostics;
using UnrealClaude::LiveCodingCompile::Testing::ClassifyRefreshStatusWithTriangulation;
using UnrealClaude::LiveCodingCompile::Testing::HasPositiveReloadSignal;
using UnrealClaude::LiveCodingCompile::Testing::HasPatchDllTimestampChange;
using UnrealClaude::LiveCodingCompile::Testing::HasAbsenceOfCompileErrors;
using UnrealClaude::LiveCodingCompile::Testing::RunNoChangeDiagnostics;

namespace UnrealClaudeLiveCodingTriangulationDetail
{
...
using namespace UnrealClaudeLiveCodingTriangulationDetail;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.AllThreeSignalsPresent_ReturnsPatched",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.Signal1AndSignal3Only_ReturnsPatchedNoReinstanceNeeded",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.Signal1AbsentWithCancelled_ReturnsCancelledUnverified",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.CompileErrorPresent_ReturnsFailed",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.LinkErrorPresent_ReturnsFailed",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.NoChangesWithExpectedDiff_EmitsAllSixDiagnosticFields",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.NoChangesWithoutExpectedDiff_ReturnsRegularNoChanges",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.DllMtimeChangedButEngineLogSilent_ReturnsCancelledUnverified",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.HasPositiveReloadSignal_DetectsAllFourMarkers",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.LiveCoding.ClassifierTriangulation.HasPatchDllTimestampChange_DetectsAdvanceAndNewDll",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FLiveCodingTriangulation_HasPatchDllTimestampChange_DetectsAdvanceAndNewDll::RunTest(const FString& /*Parameters*/)
{
	// Case 1: mtime advanced on existing DLL.
	{
		...
		Pre.Add(TEXT("UnrealEditor-UnrealClaude.dll"), T0);
		Post.Add(TEXT("UnrealEditor-UnrealClaude.dll"), T1);
	...
	// Case 2: new Patch DLL appeared only post-call.
	{
		TMap<FString, FDateTime> Pre;
		TMap<FString, FDateTime> Post;
		Pre.Add(TEXT("UnrealEditor-UnrealClaude.dll"), FDateTime(2026, 4, 19, 10, 0, 0));
		Post.Add(TEXT("UnrealEditor-UnrealClaude.dll"), FDateTime(2026, 4, 19, 10, 0, 0));
		Post.Add(TEXT("UnrealEditor-UnrealClaude.Patch_1.dll"), FDateTime(2026, 4, 19, 10, 5, 0));
	...
	// Case 3: no changes — mtime identical.
	{
		...
		Pre.Add(TEXT("UnrealEditor-UnrealClaude.dll"), T);
		Post.Add(TEXT("UnrealEditor-UnrealClaude.dll"), T);

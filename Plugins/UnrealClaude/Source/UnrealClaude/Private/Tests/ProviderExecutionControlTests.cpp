...
namespace
{
	...
	FAgentBackendStatus MakeSyntheticStatus(const EUnrealClaudeProviderBackend Backend)
	{
		FAgentBackendStatus Status;
		Status.Backend = Backend;
		Status.DisplayName = Backend == EUnrealClaudeProviderBackend::CodexCli ? TEXT("Codex CLI") : TEXT("Claude CLI");
		...
		Status.Capabilities.bSupportsToolAllowList = Backend == EUnrealClaudeProviderBackend::ClaudeCli;
		return Status;
	}
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.Manifest.CodexTruth",
...
bool FProviderExecutionControl_CodexManifestTruth::RunTest(const FString& Parameters)
{
	const FAgentProviderExecutionControlManifest Manifest = BuildAgentProviderExecutionControlManifest(
		MakeSyntheticStatus(EUnrealClaudeProviderBackend::CodexCli),
		MakeSyntheticConfig(EUnrealClaudeProviderBackend::CodexCli));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.Manifest.ClaudeTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
{
	const FAgentProviderExecutionControlManifest Manifest = BuildAgentProviderExecutionControlManifest(
		MakeSyntheticStatus(EUnrealClaudeProviderBackend::ClaudeCli),
		MakeSyntheticConfig(EUnrealClaudeProviderBackend::ClaudeCli));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.Manifest.ReadOnlyDiagnosticTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FProviderExecutionControl_ReadOnlyManifestTruth::RunTest(const FString& Parameters)
{
	const FAgentProviderExecutionControlManifest Manifest = BuildAgentProviderExecutionControlManifest(
		MakeSyntheticStatus(EUnrealClaudeProviderBackend::CodexCli),
		MakeSyntheticConfig(EUnrealClaudeProviderBackend::CodexCli, EAgentExecutionRunProfile::ReadOnlyDiagnostic));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.Manifest.BoundedPluginMutationTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FProviderExecutionControl_BoundedManifestTruth::RunTest(const FString& Parameters)
{
	const FAgentProviderExecutionControlManifest Manifest = BuildAgentProviderExecutionControlManifest(
		MakeSyntheticStatus(EUnrealClaudeProviderBackend::CodexCli),
		MakeSyntheticConfig(EUnrealClaudeProviderBackend::CodexCli, EAgentExecutionRunProfile::BoundedPluginMutation));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.Manifest.ExplicitExpertOptInTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FProviderExecutionControl_ExplicitExpertManifestTruth::RunTest(const FString& Parameters)
{
	const FAgentProviderExecutionControlManifest Manifest = BuildAgentProviderExecutionControlManifest(
		MakeSyntheticStatus(EUnrealClaudeProviderBackend::CodexCli),
		MakeSyntheticConfig(EUnrealClaudeProviderBackend::CodexCli, EAgentExecutionRunProfile::ExplicitExpertOptIn));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.Manifest.CanonicalLaneSchemaTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.Manifest.PolicyDenyContractTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FProviderExecutionControl_PolicyDenyContractTruth::RunTest(const FString& Parameters)
{
	FAgentRequestConfig Config = MakeSyntheticConfig(EUnrealClaudeProviderBackend::CodexCli, EAgentExecutionRunProfile::ReadOnlyDiagnostic);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.Manifest.BoundedPolicyDenyContractTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FProviderExecutionControl_BoundedPolicyDenyContractTruth::RunTest(const FString& Parameters)
{
	const FAgentRequestConfig Config = MakeSyntheticConfig(EUnrealClaudeProviderBackend::CodexCli, EAgentExecutionRunProfile::BoundedPluginMutation);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.MCP.RepresentativeSurfaceDenyTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.MCP.BroadMutationBucketDenyTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.MCP.TaskSubmitPolicyBoundaryTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.MCP.CanonScopedEnhancedInputAllowedOnConfiguredDefault",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FProviderExecutionControl_CanonScopedEnhancedInputAllowedOnConfiguredDefault::RunTest(const FString& Parameters)
{
	...
	TestTrue(TEXT("canon-scoped prompt should expose enhanced_input"), Config.AllowedTools.Contains(TEXT("mcp__unrealclaude__enhanced_input")));

	const FAgentBackendStatus Status = MakeSyntheticStatus(EUnrealClaudeProviderBackend::CodexCli);
	const FString RunId = FUnrealClaudeAgentTraceLog::Get().BeginRun(Status, Config, Prompt, true, true);
	...
	FUnrealClaudeAgentTraceLog::Get().CompleteRun(RunId, Status.Backend, TEXT("validation failed as expected"), false);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.MCP.ExternalUiBucketDenyTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.MCP.ExpertLaneStillSeparateForRepresentativeSurface",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.MCP.IntegratedRuntimeProofBaseline",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FProviderExecutionControl_IntegratedRuntimeProofBaseline::RunTest(const FString& Parameters)
{
...

	{
		...
		ParamsObject->SetStringField(TEXT("symbol"), TEXT("UUnrealClaudeSettings"));
		...
		if (Result.bSuccess && Result.Data.IsValid())
		{
			...
			if (ContractObjectPtr && (*ContractObjectPtr).IsValid())
			{
				...
				bOverallSuccess &= TestEqual(TEXT("bounded_plugin_mutation cpp_reflection should resolve UUnrealClaudeSettings"), CppName, FString(TEXT("UUnrealClaudeSettings")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.PluginSettingsManifest",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FProviderExecutionControl_CppDeclarationLaneGovernanceTruth,
	"UnrealClaude.ProviderExecutionControl.MCP.CppDeclarationLaneGovernanceTruth",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FProviderExecutionControl_PluginSettingsManifest::RunTest(const FString& Parameters)
{
	...
	const FAgentProviderExecutionControlManifest LiveExplicitExpertManifest =
		FClaudeCodeSubsystem::Get().GetConfiguredBackendExecutionControlManifestForProfile(EAgentExecutionRunProfile::ExplicitExpertOptIn);
	...
	TestTrue(
		...
		JsonStringArrayContains(ManifestObject, TEXT("requested_allowed_tools"), TEXT("mcp__unrealclaude__restart_survival")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.AgentTrace.RunStartedManifest",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FProviderExecutionControl_AgentTraceRunStartedManifest::RunTest(const FString& Parameters)
{
	...
	Config.ExecutionTransportLabel = Status.Backend == EUnrealClaudeProviderBackend::CodexCli
		? (FClaudeCodeSubsystem::Get().GetConfiguredBackendExecutionControlManifest().ExecutionTransportLabel)
		: TEXT("cli_process");
	...
	const FString RunId = FUnrealClaudeAgentTraceLog::Get().BeginRun(
		...
		false,
		false);
	FUnrealClaudeAgentTraceLog::Get().CompleteRun(RunId, Status.Backend, TEXT("trace probe complete"), true);
	...
	int32 TotalLoaded = 0;
	const TArray<TSharedPtr<FJsonObject>> Records = FUnrealClaudeAgentTraceLog::Get().QueryEvents(QueryOptions, ResolvedRunId, TotalLoaded);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.AgentTrace.RunStartedReadOnlyManifest",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FProviderExecutionControl_AgentTraceRunStartedExplicitExpertManifest,
	"UnrealClaude.ProviderExecutionControl.AgentTrace.RunStartedExplicitExpertManifest",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FProviderExecutionControl_AgentTraceRunStartedExplicitExpertManifest::RunTest(const FString& Parameters)
{
	...
	const FString RunId = FUnrealClaudeAgentTraceLog::Get().BeginRun(
		...
		false,
		false);
	FUnrealClaudeAgentTraceLog::Get().CompleteRun(RunId, Status.Backend, TEXT("explicit expert trace probe complete"), true);
...
bool FProviderExecutionControl_AgentTraceRunStartedReadOnlyManifest::RunTest(const FString& Parameters)
{
	...
	const FString RunId = FUnrealClaudeAgentTraceLog::Get().BeginRun(
		...
		false,
		false);
	FUnrealClaudeAgentTraceLog::Get().CompleteRun(RunId, Status.Backend, TEXT("read-only trace probe complete"), true);
	...
	TestEqual(
		...
		ExecutionTransport,
		Status.Backend == EUnrealClaudeProviderBackend::CodexCli ? FString(TEXT("exec_per_message")) : FString(TEXT("cli_process")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ProviderExecutionControl.AgentTrace.PolicyDeniedContract",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FProviderExecutionControl_AgentTracePolicyDeniedContract::RunTest(const FString& Parameters)
{
	...
	FUnrealClaudeAgentTraceLog::Get().AppendEvent(
		...
		RunId);
	FUnrealClaudeAgentTraceLog::Get().CompleteRun(RunId, Status.Backend, Contract.DenyReason, false);

...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CppReflection.ListContracts",
...
bool FCppReflection_ListContracts::RunTest(const FString& Parameters)
{
	...
	ParamsObject->SetStringField(TEXT("module_filter"), TEXT("UnrealClaude"));
	...
	for (const TSharedPtr<FJsonValue>& ContractValue : *Contracts)
	{
		...
		bSawSettingsClass = bSawSettingsClass || CppName == TEXT("UUnrealClaudeSettings");
	...
	TestTrue(TEXT("list should include UUnrealClaudeSettings"), bSawSettingsClass);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CppReflection.GetContract",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CppReflection.GetEnumContract",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FCppReflection_GetEnumContract::RunTest(const FString& Parameters)
{
	...
	TSharedRef<FJsonObject> ParamsObject = MakeShared<FJsonObject>();
	ParamsObject->SetStringField(TEXT("operation"), TEXT("get_reflected_contract"));
	ParamsObject->SetStringField(TEXT("symbol"), TEXT("EUnrealClaudeScopeMode"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CppReflection.PreviewPropertyMetadataMutation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FCppReflection_PreviewReflectedPropertyDeclaration,
	"UnrealClaude.CppReflection.PreviewReflectedPropertyDeclaration",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CppReflection.PreviewReflectedPropertyDeclarationBlockedShape",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CppReflection.ApplyReflectedPropertyDeclaration",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FCppReflection_ApplyReflectedPropertyDeclaration::RunTest(const FString& Parameters)
{
	...
	PreviewParams->SetStringField(TEXT("symbol"), TEXT("UUnrealClaudeSettings"));
	...
	ApplyParams->SetStringField(TEXT("symbol"), TEXT("UUnrealClaudeSettings"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CppReflection.ApplyReflectedPropertyDeclarationBlockedShape",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FCppReflection_BuildReflectedPropertyDeclarationEvidenceBundleSuccess,
	"UnrealClaude.CppReflection.BuildReflectedPropertyDeclarationEvidenceBundleSuccess",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FCppReflection_BuildReflectedPropertyDeclarationEvidenceBundleFailedBuild,
	"UnrealClaude.CppReflection.BuildReflectedPropertyDeclarationEvidenceBundleFailedBuild",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FCppReflection_BuildReflectedPropertyDeclarationEvidenceBundleRevertCloseout,
	"UnrealClaude.CppReflection.BuildReflectedPropertyDeclarationEvidenceBundleRevertCloseout",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FCppReflection_InspectReflectedPropertyDeclarationBuildFailure,
	"UnrealClaude.CppReflection.InspectReflectedPropertyDeclarationBuildFailure",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FCppReflection_InspectReflectedPropertyDeclarationBuildFailure::RunTest(const FString& Parameters)
{
	...
	const FString AutomationDirectory = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealClaude"), TEXT("Automation"));
...
bool FCppReflection_BuildReflectedPropertyDeclarationEvidenceBundleSuccess::RunTest(const FString& Parameters)
{
	...
	ReadbackParams->SetStringField(TEXT("symbol"), TEXT("UUnrealClaudeSettings"));
	...
	SyntheticProperty->SetStringField(TEXT("declared_in"), TEXT("UUnrealClaudeSettings"));
		...
		if (ReportArtifactObject.IsValid())
		{
			...
			if (ReportObject.IsValid())
			{
				...
				const FString ExpectedErrorPreview = FString::Printf(
					TEXT("error C2059 at UnrealClaudeSettings.h(%d,7)"),
					MemberLineNumber);
...
bool FCppReflection_PreviewPropertyMetadataMutation::RunTest(const FString& Parameters)
{
	...
	TestTrue(TEXT("preview header should point at UnrealClaudeSettings.h"), HeaderPath.EndsWith(TEXT("UnrealClaudeSettings.h")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CppReflection.ApplyPropertyMetadataMutation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CppReflection.Registry.ToolsRegistered",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

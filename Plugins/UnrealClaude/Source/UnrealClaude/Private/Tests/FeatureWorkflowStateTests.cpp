...
namespace
{
	FAgentCanonExecution MakeInteractionAccessExecution()
	{
		...
		return UnrealClaudeCanonRouting::BuildInitialCanonExecution(
	...
	FUnrealClaudeActivePlan MakeInteractionAccessPlan(FAgentCanonExecution& OutExecution, const FString& CurrentPhase)
	{
		...
		const FString& ToolResultContent = FString())
	{
		...
		Event.Backend = EUnrealClaudeProviderBackend::CodexCli;
	...
	{
		SClaudeEditorWidget::ApplyFeatureWorkflowToolBoundaryForTest(Plan, Execution, StartEvent, true);
		SClaudeEditorWidget::ApplyFeatureWorkflowToolBoundaryForTest(Plan, Execution, ResultEvent, false);
	}
		...
		const FAgentCanonExecution& Execution)
	{
		...
		ApplyProbe(
			...
			TEXT("Get-Content Saved/UnrealClaude/active_plan.json"),
		...
		ApplyProbe(
			...
			TEXT("Get-Content Docs/UnrealClaude/prison_access_slice_v2.md"),
		...
		ApplyProbe(
			...
			TEXT("Select-String -Path Docs/UnrealClaude/*.md -Pattern \"Alternative.PrisonAccess|ProofFixtureSmoke|PrisonAccessEvent\""),
		...
		const FAgentCanonExecution& Execution)
	{
		...
		{
			SClaudeEditorWidget::ApplyFeatureWorkflowToolBoundaryForTest(
				Plan,
				Execution,
	...
	void PrimeInteractionAccessProofPrereqsAndObservation(FUnrealClaudeActivePlan& Plan)
	{
	...
	{
		const FString Command =
			TEXT("Get-Content Saved/UnrealClaude/active_plan.json; git status --short; ")
			TEXT("Get-Content Plugins/UnrealClaude/Source/UnrealClaude/Private/ClaudeEditorWidget.cpp -TotalCount 1");
		const FString Result =
	...
	{
		const FString Command =
			TEXT("& 'D:/Program Files/Epic Games/UE_5.7/Engine/Build/BatchFiles/Build.bat' AlternativeEditor Win64 Development -Project='D:/VibeCode/Unreal/Alternative/Alternative/Alternative.uproject'");
		const FString Result =
			TEXT("Unhandled exception: System.UnauthorizedAccessException: Access to the path 'C:/Users/user/AppData/Local/UnrealBuildTool/Log.txt' is denied.\n")
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.FeatureWorkflowState.RoleContractRoundTripsThroughJson",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InputAssetAuthoringAllowsPersistentReuseVerification,
	"UnrealClaude.FeatureWorkflowState.InputAssetAuthoringAllowsPersistentReuseVerification",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InputAssetAuthoringAccumulatesReadOnlyReuseAcrossMultipleTools,
	"UnrealClaude.FeatureWorkflowState.InputAssetAuthoringAccumulatesReadOnlyReuseAcrossMultipleTools",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InputAssetAuthoringRejectsWeakReuseEvidence,
	"UnrealClaude.FeatureWorkflowState.InputAssetAuthoringRejectsWeakReuseEvidence",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InputAssetAuthoringRejectsPartialAccumulatedReuseEvidence,
	"UnrealClaude.FeatureWorkflowState.InputAssetAuthoringRejectsPartialAccumulatedReuseEvidence",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InputAssetAuthoringIgnoresEarlyCommandExecutionNoiseAndReachesAttemptResolver,
	"UnrealClaude.FeatureWorkflowState.InputAssetAuthoringIgnoresEarlyCommandExecutionNoiseAndReachesAttemptResolver",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InteractionContractIgnoresOptionalContextFailuresAndReachesMemoryUpdate,
	"UnrealClaude.FeatureWorkflowState.InteractionContractIgnoresOptionalContextFailuresAndReachesMemoryUpdate",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InteractionContractPreflightProofContextDoesNotSelfStop,
	"UnrealClaude.FeatureWorkflowState.InteractionContractPreflightProofContextDoesNotSelfStop",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InteractionContractUnrelatedReadOnlyDriftStillStopLosses,
	"UnrealClaude.FeatureWorkflowState.InteractionContractUnrelatedReadOnlyDriftStillStopLosses",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InteractionContractMissingProofContextStillReportsPrerequisites,
	"UnrealClaude.FeatureWorkflowState.InteractionContractMissingProofContextStillReportsPrerequisites",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InteractionAccessReview5LiveTraceReplayReachesMemoryUpdate,
	"UnrealClaude.FeatureWorkflowState.InteractionAccessReview5LiveTraceReplayReachesMemoryUpdate",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InputAssetAuthoringDoesNotStopLossOnLiveReadOnlyContextBurst,
	"UnrealClaude.FeatureWorkflowState.InputAssetAuthoringDoesNotStopLossOnLiveReadOnlyContextBurst",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InputAssetAuthoringStillStopsOnUnboundedIrrelevantCommandDrift,
	"UnrealClaude.FeatureWorkflowState.InputAssetAuthoringStillStopsOnUnboundedIrrelevantCommandDrift",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_LiveProofEvidenceAfterContextBurstLatchesPrerequisites,
	"UnrealClaude.FeatureWorkflowState.LiveProofEvidenceAfterContextBurstLatchesPrerequisites",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AttemptResolverEvidenceAfterContextBurstSerializesObservation,
	"UnrealClaude.FeatureWorkflowState.AttemptResolverEvidenceAfterContextBurstSerializesObservation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_LiveMcpToolNamesCompleteInputAssetAuthoringBeforeDriftStopLoss,
	"UnrealClaude.FeatureWorkflowState.LiveMcpToolNamesCompleteInputAssetAuthoringBeforeDriftStopLoss",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_RuntimeProofToolDoesNotBypassAttemptResolverObservation,
	"UnrealClaude.FeatureWorkflowState.RuntimeProofToolDoesNotBypassAttemptResolverObservation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_OpenLevelAloneDoesNotMarkPlacedRuntimeActorsAvailable,
	"UnrealClaude.FeatureWorkflowState.OpenLevelAloneDoesNotMarkPlacedRuntimeActorsAvailable",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review13RuntimeActorStateHydratesAfterSourceInspectionErrors,
	"UnrealClaude.FeatureWorkflowState.Review13.RuntimeActorStateHydratesAfterSourceInspectionErrors",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review13RuntimeActorStateRejectsNarrativeAndShellDrift,
	"UnrealClaude.FeatureWorkflowState.Review13.RuntimeActorStateRejectsNarrativeAndShellDrift",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review14RuntimeProofCompletesFromBoundedAutomationProof,
	"UnrealClaude.FeatureWorkflowState.Review14.RuntimeProofCompletesFromBoundedAutomationProof",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review14AdHocRuntimeProofAttemptsStillStopLossWithoutAutomationProof,
	"UnrealClaude.FeatureWorkflowState.Review14.AdHocRuntimeProofAttemptsStillStopLossWithoutAutomationProof",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AttemptResolverAndLoggingCompletesFromAccumulatedSourceInspection,
	"UnrealClaude.FeatureWorkflowState.AttemptResolverAndLoggingCompletesFromAccumulatedSourceInspection",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AttemptResolverAndLoggingCompletesFromRelativeCommandExecutionSourceInspection,
	"UnrealClaude.FeatureWorkflowState.AttemptResolverAndLoggingCompletesFromRelativeCommandExecutionSourceInspection",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AttemptResolverAndLoggingCompletesFromLiveCommandExecutionResultShape,
	"UnrealClaude.FeatureWorkflowState.AttemptResolverAndLoggingCompletesFromLiveCommandExecutionResultShape",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AttemptResolverAndLoggingCompletesFromRuntimeSmokeLogReview,
	"UnrealClaude.FeatureWorkflowState.AttemptResolverAndLoggingCompletesFromRuntimeSmokeLogReview",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AttemptResolverAndLoggingCompletesFromBoundedAutomationCommandExecution,
	"UnrealClaude.FeatureWorkflowState.AttemptResolverAndLoggingCompletesFromBoundedAutomationCommandExecution",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AttemptResolverAndLoggingRejectsDocsAndArbitraryCommandDrift,
	"UnrealClaude.FeatureWorkflowState.AttemptResolverAndLoggingRejectsDocsAndArbitraryCommandDrift",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AttemptResolverAndLoggingRejectsMutatingCommandExecutionDrift,
	"UnrealClaude.FeatureWorkflowState.AttemptResolverAndLoggingRejectsMutatingCommandExecutionDrift",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AttemptResolverAndLoggingReadOnlySourceProgressAvoidsPrematureStopLoss,
	"UnrealClaude.FeatureWorkflowState.AttemptResolverAndLoggingReadOnlySourceProgressAvoidsPrematureStopLoss",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_ProofContextObservationAdvancesWithoutMutation,
	"UnrealClaude.FeatureWorkflowState.ProofContextObservationAdvancesWithoutMutation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AutomationDiscoveryAcceptsRealSuccessMarkers,
	"UnrealClaude.FeatureWorkflowState.AutomationDiscoveryAcceptsRealSuccessMarkers",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AutomationDiscoveryAcceptsSummaryCountsWithCleanExit,
	"UnrealClaude.FeatureWorkflowState.AutomationDiscoveryAcceptsSummaryCountsWithCleanExit",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AutomationDiscoveryZeroDiscoveryStillFails,
	"UnrealClaude.FeatureWorkflowState.AutomationDiscoveryZeroDiscoveryStillFails",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_CompileGateVerificationOnlyAutomationAdvances,
	"UnrealClaude.FeatureWorkflowState.CompileGateVerificationOnlyAutomationAdvances",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_CompileGateDoesNotAdvanceOnArbitraryCommandExecution,
	"UnrealClaude.FeatureWorkflowState.CompileGateDoesNotAdvanceOnArbitraryCommandExecution",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_CompileGateRequiredCompileBlocksAutomationAdvance,
	"UnrealClaude.FeatureWorkflowState.CompileGateRequiredCompileBlocksAutomationAdvance",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review9VerificationOnlyFlowDoesNotParkAtCompileGate,
	"UnrealClaude.FeatureWorkflowState.Review9VerificationOnlyFlowDoesNotParkAtCompileGate",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_CompileGateNoCompileRequiredAdvancesWithoutUBT,
	"UnrealClaude.FeatureWorkflowState.CompileGateNoCompileRequiredAdvancesWithoutUBT",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_AutomationProofBeforeCompileGateIsCarriedForward,
	"UnrealClaude.FeatureWorkflowState.AutomationProofBeforeCompileGateIsCarriedForward",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review10FullLiveNewSessionTraceReachesMemoryUpdate,
	"UnrealClaude.FeatureWorkflowState.Review10FullLiveNewSessionTraceReachesMemoryUpdate",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review10DelayedSourceResultsDoNotSpendInputPhaseStopLoss,
	"UnrealClaude.FeatureWorkflowState.Review10DelayedSourceResultsDoNotSpendInputPhaseStopLoss",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_SourceInspectionEvidenceHydratesAttemptResolverObservationAcrossPhaseBoundaries,
	"UnrealClaude.FeatureWorkflowState.SourceInspectionEvidenceHydratesAttemptResolverObservationAcrossPhaseBoundaries",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_InputAssetAuthoringUsesAccumulatedSeparateAssetAndEnhancedInputEvidence,
	"UnrealClaude.FeatureWorkflowState.InputAssetAuthoringUsesAccumulatedSeparateAssetAndEnhancedInputEvidence",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_StdoutOnlyAutomationLogCountsWhenAbsLogFileMissing,
	"UnrealClaude.FeatureWorkflowState.StdoutOnlyAutomationLogCountsWhenAbsLogFileMissing",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review11AutomationDiscoveryGateAcceptsPassingAbsLogAfterNoise,
	"UnrealClaude.FeatureWorkflowState.Review11AutomationDiscoveryGateAcceptsPassingAbsLogAfterNoise",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review11AutomationDiscoveryHydratesRuntimeSmokeAndPrisonAccessEvent,
	"UnrealClaude.FeatureWorkflowState.Review11AutomationDiscoveryHydratesRuntimeSmokeAndPrisonAccessEvent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review11AutomationNoiseDoesNotCauseFalseDiscoveryFailure,
	"UnrealClaude.FeatureWorkflowState.Review11AutomationNoiseDoesNotCauseFalseDiscoveryFailure",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_Review11AutomationNoiseWithoutPassingProofStillFails,
	"UnrealClaude.FeatureWorkflowState.Review11AutomationNoiseWithoutPassingProofStillFails",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_ProjectLocalReadOnlyEvidenceDoesNotSpendStopLossBudgetWhenItAddsOrConfirmsEvidence,
	"UnrealClaude.FeatureWorkflowState.ProjectLocalReadOnlyEvidenceDoesNotSpendStopLossBudgetWhenItAddsOrConfirmsEvidence",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_CompileGateReadOnlyPlanInspectionDoesNotConsumeStopLossWhenCompileNotRequired,
	"UnrealClaude.FeatureWorkflowState.CompileGateReadOnlyPlanInspectionDoesNotConsumeStopLossWhenCompileNotRequired",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_CompileGateArbitraryCommandDriftStillStopLosses,
	"UnrealClaude.FeatureWorkflowState.CompileGateArbitraryCommandDriftStillStopLosses",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_UbtLogBackupUnauthorizedIsInfrastructureBlockerNotCompileFailure,
	"UnrealClaude.FeatureWorkflowState.UbtLogBackupUnauthorizedIsInfrastructureBlockerNotCompileFailure",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_VerificationArchiveWriteWithSourceEvidenceDoesNotRequireCompileProof,
	"UnrealClaude.FeatureWorkflowState.VerificationArchiveWriteWithSourceEvidenceDoesNotRequireCompileProof",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FFeatureWorkflowState_RealSourceWriteStillRequiresCompileProof,
	"UnrealClaude.FeatureWorkflowState.RealSourceWriteStillRequiresCompileProof",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FFeatureWorkflowState_InputAssetAuthoringAllowsPersistentReuseVerification::RunTest(const FString& Parameters)
{
	...
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("input_asset_authoring"));
	...
	const FString& Parameters)
{
	...
	for (int32 Index = 0; Index < 2; ++Index)
	{
		const FString NoiseCommand = FString::Printf(
			TEXT("Select-String -Path Docs/UnrealClaude/*.md -Pattern \"IMC_PrisonAccessProof\" # early context probe %d"),
			Index);
		const FString NoiseResult =
			TEXT("Select-String : Cannot find path 'Docs/UnrealClaude/*.md' because it does not exist.");
		ApplyToolRoundTrip(
			Plan,
			Execution,
	...
	const FString AutomationWrapperResult =
		...
		TEXT("LogAlternative: Display: PrisonAccessEvent order=1 actor=subject.player.technician target=AlternativeTechnicalBox_0 attempt=1 result=3 noisy=false tag=attempt.technical.override_success\n")
		TEXT("LogAlternative: Display: PrisonAccessEvent order=2 actor=subject.player.technician target=AlternativeStorageDoor_0 attempt=0 result=4 noisy=false tag=attempt.access.open_existing\n")
		TEXT("STDOUT_LOG=D:/VibeCode/Unreal/Alternative/Alternative/Saved/Logs/packet654_rerun_stdout_20260424_011743.log\n")
		TEXT("AUTOMATION_LOG=D:/VibeCode/Unreal/Alternative/Alternative/Saved/Logs/packet654_rerun_automation_20260424_011743.log");
	ApplyToolRoundTrip(
		Plan,
		Execution,
...
{
	FAgentCanonExecution Execution;
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("interaction_contract"));
	...
	const FString MissingProtocolRawJson =
		TEXT("{\"type\":\"commandExecution\",\"id\":\"call_missing_protocol\",\"command\":\"Get-Content -LiteralPath 'AgentBridge\\\\PROTOCOL.md'\",\"cwd\":\"D:/VibeCode/Unreal/Alternative/Alternative\",\"status\":\"failed\",\"exitCode\":1}");
	...
	const FString RgContextRawJson =
		TEXT("{\"type\":\"commandExecution\",\"id\":\"call_rg_context\",\"command\":\"rg -n \\\"packet654|Alternative.PrisonAccess|ProofFixtureSmoke|PrisonAccessEvent|Result=\\\\{Success\\\\}\\\" AgentBridge Docs Saved -g \\\"*.md\\\" -g \\\"*.json\\\" -g \\\"*.log\\\"\",\"cwd\":\"D:/VibeCode/Unreal/Alternative/Alternative\",\"status\":\"failed\",\"exitCode\":1}");
	const FString RgContextResult =
		TEXT("Docs\\UnrealClaude\\prison_access_slice_v2.md:61:- discovery result: Found 7 automation tests based on 'Alternative.PrisonAccess'\n")
		TEXT("Docs\\UnrealClaude\\prison_access_slice_v2.md:63:- Alternative.PrisonAccess.ProofFixtureSmoke completed with Result={Success}\n")
		TEXT("Docs\\UnrealClaude\\prison_access_slice_v2.md:64:- PrisonAccessEvent order=1 tag=attempt.technical.override_success");
	ApplyToolRoundTrip(
		Plan,
		Execution,
	...
	const FString& Parameters)
{
	...
	AddPreflight(
		...
		TEXT("Get-Content -Path Saved/UnrealClaude/closeout_decision.json -Raw"),
		TEXT("{\"source_project_root\":\"D:/VibeCode/Unreal/Alternative/Alternative\",\"facts_consumed\":{\"bounded_interaction_access_runtime_proof\":true},\"recipe_id\":\"feature.interaction_access_slice_v1\"}"));
	AddPreflight(
		TEXT("call_v2_preflight_archives"),
		TEXT("Get-ChildItem -Path Saved/UnrealClaude/PlanArchives -Force"),
	...
	AddPreflight(
		...
		TEXT("Select-String -Path Docs/UnrealClaude/prison_access_slice_v2.md -Pattern 'Alternative.PrisonAccess|ProofFixtureSmoke|PrisonAccessEvent'"),
	...
	{
		SClaudeEditorWidget::ApplyFeatureWorkflowToolBoundaryForTest(Plan, Execution, Start, true);
	}
	...
	{
		SClaudeEditorWidget::ApplyFeatureWorkflowToolBoundaryForTest(Plan, Execution, Result, false);
	}
	...
	const FString& Parameters)
{
	...
	for (int32 Index = 0; Index < 6; ++Index)
	{
		...
		const FString Command = FString::Printf(
			TEXT("Get-Content -Path Docs/UnrealClaude/missing_preflight_%d.md"),
			Index);
		Starts.Add(MakeCommandExecutionEvent(ToolCallId, Command));
...
{
	FAgentCanonExecution Execution;
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("project_context_preflight"));
	...
	ApplyInputReuseEvidence(Plan, Execution, TEXT("unrealclaude/"));
	ApplyRuntimeActorEvidence(Plan, Execution, TEXT("unrealclaude/"));
	...
	const FString& Parameters)
{
	...
	ApplyToolRoundTrip(
		Plan,
		Execution,
		MakeToolEvent(TEXT("unrealclaude/capture_viewport"), TEXT("call_live_capture_viewport"), TEXT("{\"reason\":\"proof actor visibility\"}")),
		MakeToolEvent(
			TEXT("unrealclaude/capture_viewport"),
...
{
	FAgentCanonExecution Execution;
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("attempt_resolver_and_logging"));
	Plan.FeatureWorkflow.bKnownProofMapAvailable = true;
	Plan.FeatureWorkflow.bPlacedRuntimeActorsAvailable = true;
	Plan.FeatureWorkflow.ProofPrerequisiteState = TEXT("satisfied");
...
{
	FAgentCanonExecution Execution;
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("proof_context_setup"));
...
{
	FAgentCanonExecution Execution;
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("runtime_actor_state"));

	const FString DocsCommand = TEXT("Get-Content Docs/UnrealClaude/prison_access_slice_v2.md");
	const FString DocsResult =
		TEXT("Docs/UnrealClaude/prison_access_slice_v2.md says Lvl_PrisonAccessProof contains ")
...
{
	FAgentCanonExecution Execution;
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("runtime_proof"));
...
bool FFeatureWorkflowState_AttemptResolverAndLoggingCompletesFromAccumulatedSourceInspection::RunTest(const FString& Parameters)
{
	...
	const FString AttemptResolverPath =
		TEXT("D:/VibeCode/Unreal/Alternative/Alternative/Source/Alternative/PrisonAccess/AlternativePrisonAccessAttemptResolver.cpp");
	...
	const FString EventSubsystemPath =
		TEXT("D:/VibeCode/Unreal/Alternative/Alternative/Source/Alternative/PrisonAccess/AlternativePrisonAccessEventSubsystem.cpp");
...
bool FFeatureWorkflowState_AttemptResolverAndLoggingCompletesFromRuntimeSmokeLogReview::RunTest(const FString& Parameters)
{
	...
	const FString LogReviewCommand =
		TEXT("Get-Content D:\\VibeCode\\Unreal\\Alternative\\Alternative\\Saved\\Logs\\packet653_rerun_stdout_20260424_003729.log");
	const FString LogReviewResult =
		TEXT("D:/VibeCode/Unreal/Alternative/Alternative/Saved/Logs/packet653_rerun_stdout_20260424_003729.log\n")
		TEXT("LogAutomationController: Display: Test Completed. Result={Success} Name={ProofFixtureSmoke} Path={Alternative.PrisonAccess.ProofFixtureSmoke}\n")
		TEXT("LogAutomationController: Display: Test Completed. Result={Success} Name={TechnicalRoute} Path={Alternative.PrisonAccess.TechnicalRoute}\n")
		TEXT("LogAutomationController: Display: Test Completed. Result={Success} Name={UnskilledRoute} Path={Alternative.PrisonAccess.UnskilledRoute}\n")
		TEXT("LogAlternative: Display: PrisonAccessEvent order=1 actor=subject.player.technician target=AlternativeTechnicalBox_0 attempt=1 result=3 noisy=false tag=attempt.technical.override_success\n")
...
bool FFeatureWorkflowState_AttemptResolverAndLoggingRejectsDocsAndArbitraryCommandDrift::RunTest(const FString& Parameters)
{
	...
	const FString DocsPath =
		TEXT("D:/VibeCode/Unreal/OsvayderPlugin/Docs/UnrealClaude/attempt_resolver_notes.md");
	...
	ApplyToolRoundTrip(
		...
		MakeCommandExecutionEvent(
			...
			TEXT("Directory: D:/VibeCode/Unreal/Alternative/Alternative/Saved/Logs\npacket653_rerun_stdout_20260424_003729.log")));
	...
	const FString& Parameters)
{
	...
	const FString DriftCommand =
		TEXT("\"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe\" -Command 'Get-Content Docs/UnrealClaude/attempt_resolver_notes.md | Tee-Object -FilePath Saved/Logs/attempt_resolver_notes_copy.log'");
...
{
	FAgentCanonExecution Execution;
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("automation_discovery_gate"));
	Plan.FeatureWorkflow.bKnownProofMapAvailable = true;
	Plan.FeatureWorkflow.bPlacedRuntimeActorsAvailable = true;
...
{
	FAgentCanonExecution Execution;
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("compile_gate"));
...
{
	FAgentCanonExecution Execution;
	FUnrealClaudeActivePlan Plan = MakeInteractionAccessPlan(Execution, TEXT("memory_update"));
	Plan.FeatureWorkflow.bCompileProofRequired = false;
	Plan.FeatureWorkflow.CompileProofState = TEXT("not_required");
	Plan.FeatureWorkflow.RuntimeProofState = TEXT("passed");

	const FString ArchiveWriteCommand =
		TEXT("$p = Get-Content Saved/UnrealClaude/active_plan.json | ConvertFrom-Json; ")
		TEXT("$p.feature_workflow.source_evidence = \"Source/Alternative/PrisonAccess/AlternativePrisonAccessAttemptResolver.cpp\"; ")
		TEXT("$p | ConvertTo-Json -Depth 32 | Set-Content Saved/UnrealClaude/PlanArchives/20260425-141636-packet654-review7-live-acceptance.active_plan.json");
	...
	ApplyToolRoundTrip(
		...
		MakeCommandExecutionEvent(
			...
			ArchiveWriteCommand,
			TEXT("ARCHIVE_PATH=Saved/UnrealClaude/PlanArchives/20260425-141636-packet654-review7-live-acceptance.active_plan.json")));

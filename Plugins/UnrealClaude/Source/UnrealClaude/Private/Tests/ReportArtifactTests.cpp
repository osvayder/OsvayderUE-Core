...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ReportArtifacts.Export.MultilingualRoundTrip",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ReportArtifacts.Status.Readback",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ReportArtifacts.Integration.MultiplayerAuditExportReadback",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.ReportArtifacts.Registry.ToolsRegistered",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

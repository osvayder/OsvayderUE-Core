...
bool FMCPParamValidator_ValidateBlueprintPath_Security::RunTest(const FString& Parameters)
{
	...
	TestFalse("Raw Windows disk paths should be blocked",
		FMCPParamValidator::ValidateBlueprintPath(TEXT("D:\\VibeCode\\Unreal\\Alternative\\Alternative\\Content\\Packet674Denied"), Error));
	...
	TestFalse("Non-mounted absolute package paths should be blocked",
		FMCPParamValidator::ValidateBlueprintPath(TEXT("/VibeCode/Unreal/Alternative/Content/Packet674Denied"), Error));

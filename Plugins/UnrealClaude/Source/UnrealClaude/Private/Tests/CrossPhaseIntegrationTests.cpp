 ...
 *
 * Reference:
 *   - Dispatch: `AgentBridge/CODEX_TO_CLAUDE.md` 2026-04-19 18:35.
 *   - Audit:    `Docs/UnrealClaude/626_P5_AdversarialCoverageAudit.md`.
 *   - Spec:     `Docs/UnrealClaude/626_CompileRoutingAndErrorSafetyCorrection_DispatchReady_v3.md` §626-P5.
 *
 * Test grouping: `UnrealClaude.CrossPhaseIntegration.*`
 *
...
namespace UnrealClaudeCrossPhaseIntegrationTestsDetail
{
	...
	FString BuildOuroborosRgOutputFixture()
	{
		...
		return FString(TEXT("Plugins/UnrealClaude/Source/UnrealClaude/Private/UnrealClaudeRestartSurvival.cpp:453:\t\t\tif (Haystack.Contains(TEXT(\""))
			+ Needle
			+ TEXT("\"))\n")
			+ TEXT("Plugins/UnrealClaude/Source/UnrealClaude/Private/UnrealClaudeRestartSurvival.cpp:461:\t\t\t\tTEXT(\"")
			+ Needle + TEXT("\"));\n");
	}
...
using namespace UnrealClaudeCrossPhaseIntegrationTestsDetail;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CrossPhaseIntegration.InspectionCommandAgainstBlockerPhrase_DetectorRejectsAndPolicyAllows",
...
{
	const FString ToolInput = FString(TEXT("rg \"")) + ComposeUhtRenameLockPhrase() + TEXT("\" Plugins/UnrealClaude/Source/");
	const FString ToolResultBody = BuildOuroborosRgOutputFixture();

	// === P2 detector path ===
	FUnrealClaudeClosedEditorBuildBlocker Blocker;
	const bool bDetectorFired = FUnrealClaudeRestartSurvivalManager::TryDetectClosedEditorBuildBlocker(
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CrossPhaseIntegration.RealBuildBlockerOutput_DetectorEscalatesPolicyEmitsAmbiguous",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CrossPhaseIntegration.ClassifierTriangulationConfirmsPatch_AfterPolicyRedirect",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CrossPhaseIntegration.PolicyDenyJsonStructure_CanBeReParsedAsStructuredTelemetry",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealClaude.CrossPhaseIntegration.AmbiguousClassificationWiringGapIsDeliberate",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)

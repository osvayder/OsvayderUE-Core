...
public:
	...
	IClaudeRunner* GetClaudeRunner() const;
	static bool ShouldResumeFeatureWorkflowFromActivePlan(const FUnrealClaudeActivePlan& ActivePlan);

private:
	IAgentBackend* GetOrCreateBackend(EUnrealClaudeProviderBackend Backend) const;

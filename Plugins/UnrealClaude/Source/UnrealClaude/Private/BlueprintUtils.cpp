...
TArray<TSharedPtr<FJsonValue>> FBlueprintUtils::GetBlueprintVariables(UBlueprint* Blueprint)
{
	...
	for (const FBPVariableDescription& Var : Blueprint->NewVariables)
	{
		...
		{
			VarObj->SetStringField(TEXT("pin_subcategory"), Var.VarType.PinSubCategory.ToString());
		}
		if (Var.VarType.PinSubCategoryObject.IsValid())
		{
			VarObj->SetStringField(TEXT("pin_subcategory_object"), Var.VarType.PinSubCategoryObject->GetPathName());
		}
		if (Var.VarType.IsContainer())
		{
		...
		{
			VarObj->SetStringField(TEXT("editor_category"), Var.Category.ToString());
		}

...
public:
	 ...
	 * @param bMacroGraph - true to search macro graphs (overrides bFunctionGraph)
...
private:
	...
	// Delegate node creation (CallDelegate, AddDelegate, RemoveDelegate, ClearDelegate)
	template<typename TNodeClass>
	static UEdGraphNode* CreateDelegateNode(UEdGraph* Graph, UBlueprint* Blueprint, const FString& DispatcherName, int32 PosX, int32 PosY, FString& OutError);

...
#include "UnrealClaudeEnginePatchProbe.h"
...
namespace
{
	...
	const TCHAR* GPatchCommentSignature = TEXT("UnrealClaude 628-v3 patch");
...
FString FUnrealClaudeEnginePatchProbe::GetEngineSourceAbsolutePath()
{
...
bool FUnrealClaudeEnginePatchProbe::DetectPatchPresence(const FString& EngineSourceContent)
{
...
void FUnrealClaudeEnginePatchProbe::RunStartupProbe()
{
	...
	else if (bFileReadOk)
	{
		UE_LOG(LogUnrealClaude, Warning,
			TEXT("Engine patch LiveCodingModule.cpp:1294 missing (likely engine reinstall overwrote it). "
				 ...
				 "run Plugins/UnrealClaude/Script/Apply_628v3_LiveCodingLimitPatch.ps1 from an elevated PowerShell."));
	}

 ...
 */
enum class EUnrealClaudeTaskRecoveryChoice : uint8
{
 ...
 */
class UNREALCLAUDE_API FUnrealClaudeTaskRecoveryDialog
{
public:
	struct FDialogResult
	{
		EUnrealClaudeTaskRecoveryChoice Choice = EUnrealClaudeTaskRecoveryChoice::None;
 ...
 * lock-step).
 */
class UNREALCLAUDE_API FUnrealClaudeTaskRecoveryContextBuilder
{
public:
	/**

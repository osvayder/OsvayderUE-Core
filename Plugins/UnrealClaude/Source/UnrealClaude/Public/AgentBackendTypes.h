...
UENUM()
enum class EUnrealClaudeProviderBackend : uint8
{
	ClaudeCli UMETA(DisplayName="Claude CLI"),
	CodexCli UMETA(DisplayName="Codex CLI"),
};

inline const TCHAR* UnrealClaudeProviderBackendToString(const EUnrealClaudeProviderBackend Backend)
{
	switch (Backend)
	{
...
inline const TCHAR* UnrealClaudeProviderBackendToSessionSlug(const EUnrealClaudeProviderBackend Backend)
{
	switch (Backend)
	{
	case EUnrealClaudeProviderBackend::CodexCli:
...
struct UNREALCLAUDE_API FAgentRunEvent
{
...
struct UNREALCLAUDE_API FAgentPromptContextBlock
{
	FString Label;
	FString Content;
};

struct UNREALCLAUDE_API FAgentPromptContract
{
	FString RoleId;
	FString RecipeId;
...
struct UNREALCLAUDE_API FAgentFeatureWorkflowPhaseState
{
	FString PhaseId;
	FString Label;
...
struct UNREALCLAUDE_API FUnrealClaudeTaskLaneState
{
	FString CurrentLane;
	FString TargetLane;
	...
	static FUnrealClaudeTaskLaneState FromJsonObject(const TSharedPtr<FJsonObject>& Object)
	{
		FUnrealClaudeTaskLaneState State;
		if (!Object.IsValid())
		{
			return State;
		}
...
struct UNREALCLAUDE_API FInteractionAccessReuseObservationState
{
...
struct UNREALCLAUDE_API FInteractionAccessAttemptResolverObservationState
{
...
struct UNREALCLAUDE_API FAgentFeatureWorkflowState
{
	...
	static FAgentFeatureWorkflowState FromJsonObject(const TSharedPtr<FJsonObject>& Object)
	{
		...
		{
			State.LaneState = FUnrealClaudeTaskLaneState::FromJsonObject(*LaneStateObject);
		}
...
struct UNREALCLAUDE_API FAgentCanonExecution
{
	 ...
	 * `ClaudeEditorWidget::SelfVerificationMismatchWarning`.
	 */
...
struct UNREALCLAUDE_API FAgentRequestConfig
{
	FString Prompt;
...
struct UNREALCLAUDE_API FAgentBackendCapabilities
{
	EUnrealClaudeProviderBackend Backend = EUnrealClaudeProviderBackend::ClaudeCli;
	FString DisplayName;
...
struct UNREALCLAUDE_API FAgentBackendStatus
{
	EUnrealClaudeProviderBackend Backend = EUnrealClaudeProviderBackend::ClaudeCli;
	FString DisplayName;
...
struct UNREALCLAUDE_API FAgentSessionMetadata
{
...
struct UNREALCLAUDE_API FAgentSavedSessionIndex
{
...
struct UNREALCLAUDE_API FAgentSessionRestoreResult
{

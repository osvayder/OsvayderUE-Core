...
struct UNREALCLAUDE_API FUnrealClaudeReportTruthSummary
{
...
struct UNREALCLAUDE_API FUnrealClaudeReportExportRequest
{
	FString ReportName;
	FString ReportSlug;
	FString ReportId;
...
struct UNREALCLAUDE_API FUnrealClaudeReportExportResult
{
	bool bSuccess = false;
...
struct UNREALCLAUDE_API FUnrealClaudeReportQueryOptions
{
	FString ReportId;
	FString RunKind;
	FString NameFilter;
...
class UNREALCLAUDE_API FUnrealClaudeReportArtifacts
{
public:
	static FString GetReportsDirectory();
	static FString GetReportSummaryGlob();
	static bool ExportReport(const FUnrealClaudeReportExportRequest& Request, FUnrealClaudeReportExportResult& OutResult);
	static TArray<TSharedPtr<FJsonObject>> QueryReports(const FUnrealClaudeReportQueryOptions& Options);
...
private:
	...
	static TSharedPtr<FJsonObject> BuildSummaryObject(const FUnrealClaudeReportExportRequest& Request);
	static void NormalizeTruthSummary(FUnrealClaudeReportTruthSummary& InOutTruthSummary);

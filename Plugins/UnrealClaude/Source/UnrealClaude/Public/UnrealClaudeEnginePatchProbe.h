 ...
 * via `LogUnrealClaude` and surfaces the state as a
 ...
 *   - `UnrealClaude 628-v3 patch` (comment breadcrumb)
 ...
 *
 * Reference:
 *   - Dispatch: `AgentBridge/CODEX_TO_CLAUDE.md` 2026-04-20 02:15 (628-v3).
 *   - Engine source: `UE_5.7/Engine/Source/Developer/Windows/LiveCoding/
 *     Private/LiveCodingModule.cpp:1294-1296`.
 *   - Audit:    `Docs/UnrealClaude/628_LiveCodingLimitOriginAudit.md`.
 */
class UNREALCLAUDE_API FUnrealClaudeEnginePatchProbe
{
public:
	/** Run the probe at editor startup (from FUnrealClaudeModule::StartupModule tail). */

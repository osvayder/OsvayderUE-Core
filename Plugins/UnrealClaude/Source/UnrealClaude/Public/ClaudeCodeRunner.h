...
public:
	...
	virtual EUnrealClaudeProviderBackend GetBackendType() const override { return EUnrealClaudeProviderBackend::ClaudeCli; }
	...
	static FString GetClaudeLanguageDisplayName(EUnrealClaudeDictationLanguage Language);
